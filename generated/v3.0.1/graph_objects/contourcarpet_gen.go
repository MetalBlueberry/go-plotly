...
var TraceTypeContourcarpet types.TraceType = "contourcarpet"

func (t *Contourcarpet) GetType() types.TraceType {
	return TraceTypeContourcarpet
}

func (t *Contourcarpet) MarshalJSON() ([]byte, error) {
...
type ContourcarpetColorbarTickfont struct {
	...
	// .schema.traces.contourcarpet.attributes.colorbar.tickfont.lineposition
	Lineposition ContourcarpetColorbarTickfontLineposition `json:"lineposition,omitempty"`

	// Shadow
	// arrayOK: false
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.contourcarpet.attributes.colorbar.tickfont.shadow
	...
	// .schema.traces.contourcarpet.attributes.colorbar.tickfont.style
	Style ContourcarpetColorbarTickfontStyle `json:"style,omitempty"`
	...
	// .schema.traces.contourcarpet.attributes.colorbar.tickfont.textcase
	Textcase ContourcarpetColorbarTickfontTextcase `json:"textcase,omitempty"`
	...
	// .schema.traces.contourcarpet.attributes.colorbar.tickfont.variant
	Variant ContourcarpetColorbarTickfontVariant `json:"variant,omitempty"`

	// Weight
	// arrayOK: false
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.contourcarpet.attributes.colorbar.tickfont.weight
	Weight types.IntegerType `json:"weight,omitempty"`
}

// ContourcarpetColorbarTickformatstop
type ContourcarpetColorbarTickformatstop struct {
...
// ContourcarpetColorbarTitleFont Sets this color bar's title font.
type ContourcarpetColorbarTitleFont struct {
	...
	// type: flaglist
	// Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
	// .schema.traces.contourcarpet.attributes.colorbar.title.font.lineposition
	Lineposition ContourcarpetColorbarTitleFontLineposition `json:"lineposition,omitempty"`

	// Shadow
	// arrayOK: false
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.contourcarpet.attributes.colorbar.title.font.shadow
	Shadow types.StringType `json:"shadow,omitempty"`
	...
	// type: enumerated
	// Sets whether a font should be styled with a normal or italic face from its family.
	// .schema.traces.contourcarpet.attributes.colorbar.title.font.style
	Style ContourcarpetColorbarTitleFontStyle `json:"style,omitempty"`
	...
	// type: enumerated
	// Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
	// .schema.traces.contourcarpet.attributes.colorbar.title.font.textcase
	Textcase ContourcarpetColorbarTitleFontTextcase `json:"textcase,omitempty"`
	...
	// type: enumerated
	// Sets the variant of the font.
	// .schema.traces.contourcarpet.attributes.colorbar.title.font.variant
	Variant ContourcarpetColorbarTitleFontVariant `json:"variant,omitempty"`

	// Weight
	// arrayOK: false
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.contourcarpet.attributes.colorbar.title.font.weight
	Weight types.IntegerType `json:"weight,omitempty"`
}
...
type ContourcarpetContoursLabelfont struct {
	...
	// type: flaglist
	// Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
	// .schema.traces.contourcarpet.attributes.contours.labelfont.lineposition
	Lineposition ContourcarpetContoursLabelfontLineposition `json:"lineposition,omitempty"`

	// Shadow
	// arrayOK: false
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.contourcarpet.attributes.contours.labelfont.shadow
	Shadow types.StringType `json:"shadow,omitempty"`
	...
	// type: enumerated
	// Sets whether a font should be styled with a normal or italic face from its family.
	// .schema.traces.contourcarpet.attributes.contours.labelfont.style
	Style ContourcarpetContoursLabelfontStyle `json:"style,omitempty"`
	...
	// type: enumerated
	// Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
	// .schema.traces.contourcarpet.attributes.contours.labelfont.textcase
	Textcase ContourcarpetContoursLabelfontTextcase `json:"textcase,omitempty"`
	...
	// type: enumerated
	// Sets the variant of the font.
	// .schema.traces.contourcarpet.attributes.contours.labelfont.variant
	Variant ContourcarpetContoursLabelfontVariant `json:"variant,omitempty"`

	// Weight
	// arrayOK: false
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.contourcarpet.attributes.contours.labelfont.weight
	Weight types.IntegerType `json:"weight,omitempty"`
}
...
type ContourcarpetLegendgrouptitleFont struct {
	...
	// type: flaglist
	// Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
	// .schema.traces.contourcarpet.attributes.legendgrouptitle.font.lineposition
	Lineposition ContourcarpetLegendgrouptitleFontLineposition `json:"lineposition,omitempty"`

	// Shadow
	// arrayOK: false
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.contourcarpet.attributes.legendgrouptitle.font.shadow
	Shadow types.StringType `json:"shadow,omitempty"`
	...
	// type: enumerated
	// Sets whether a font should be styled with a normal or italic face from its family.
	// .schema.traces.contourcarpet.attributes.legendgrouptitle.font.style
	Style ContourcarpetLegendgrouptitleFontStyle `json:"style,omitempty"`
	...
	// type: enumerated
	// Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
	// .schema.traces.contourcarpet.attributes.legendgrouptitle.font.textcase
	Textcase ContourcarpetLegendgrouptitleFontTextcase `json:"textcase,omitempty"`
	...
	// type: enumerated
	// Sets the variant of the font.
	// .schema.traces.contourcarpet.attributes.legendgrouptitle.font.variant
	Variant ContourcarpetLegendgrouptitleFontVariant `json:"variant,omitempty"`

	// Weight
	// arrayOK: false
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.contourcarpet.attributes.legendgrouptitle.font.weight
	Weight types.IntegerType `json:"weight,omitempty"`
}
...
// ContourcarpetColorbarTickfontStyle Sets whether a font should be styled with a normal or italic face from its family.
// .schema.traces.contourcarpet.attributes.colorbar.tickfont.style
type ContourcarpetColorbarTickfontStyle string

const (
	ContourcarpetColorbarTickfontStyleNormal ContourcarpetColorbarTickfontStyle = "normal"
	ContourcarpetColorbarTickfontStyleItalic ContourcarpetColorbarTickfontStyle = "italic"
)

// ContourcarpetColorbarTickfontTextcase Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
// .schema.traces.contourcarpet.attributes.colorbar.tickfont.textcase
type ContourcarpetColorbarTickfontTextcase string

const (
	ContourcarpetColorbarTickfontTextcaseNormal   ContourcarpetColorbarTickfontTextcase = "normal"
	ContourcarpetColorbarTickfontTextcaseWordCaps ContourcarpetColorbarTickfontTextcase = "word caps"
	ContourcarpetColorbarTickfontTextcaseUpper    ContourcarpetColorbarTickfontTextcase = "upper"
	ContourcarpetColorbarTickfontTextcaseLower    ContourcarpetColorbarTickfontTextcase = "lower"
)

// ContourcarpetColorbarTickfontVariant Sets the variant of the font.
// .schema.traces.contourcarpet.attributes.colorbar.tickfont.variant
type ContourcarpetColorbarTickfontVariant string

const (
	ContourcarpetColorbarTickfontVariantNormal        ContourcarpetColorbarTickfontVariant = "normal"
	ContourcarpetColorbarTickfontVariantSmallCaps     ContourcarpetColorbarTickfontVariant = "small-caps"
	ContourcarpetColorbarTickfontVariantAllSmallCaps  ContourcarpetColorbarTickfontVariant = "all-small-caps"
	ContourcarpetColorbarTickfontVariantAllPetiteCaps ContourcarpetColorbarTickfontVariant = "all-petite-caps"
	ContourcarpetColorbarTickfontVariantPetiteCaps    ContourcarpetColorbarTickfontVariant = "petite-caps"
	ContourcarpetColorbarTickfontVariantUnicase       ContourcarpetColorbarTickfontVariant = "unicase"
)
...
// ContourcarpetColorbarTitleFontStyle Sets whether a font should be styled with a normal or italic face from its family.
// .schema.traces.contourcarpet.attributes.colorbar.title.font.style
type ContourcarpetColorbarTitleFontStyle string

const (
	ContourcarpetColorbarTitleFontStyleNormal ContourcarpetColorbarTitleFontStyle = "normal"
	ContourcarpetColorbarTitleFontStyleItalic ContourcarpetColorbarTitleFontStyle = "italic"
)

// ContourcarpetColorbarTitleFontTextcase Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
// .schema.traces.contourcarpet.attributes.colorbar.title.font.textcase
type ContourcarpetColorbarTitleFontTextcase string

const (
	ContourcarpetColorbarTitleFontTextcaseNormal   ContourcarpetColorbarTitleFontTextcase = "normal"
	ContourcarpetColorbarTitleFontTextcaseWordCaps ContourcarpetColorbarTitleFontTextcase = "word caps"
	ContourcarpetColorbarTitleFontTextcaseUpper    ContourcarpetColorbarTitleFontTextcase = "upper"
	ContourcarpetColorbarTitleFontTextcaseLower    ContourcarpetColorbarTitleFontTextcase = "lower"
)

// ContourcarpetColorbarTitleFontVariant Sets the variant of the font.
// .schema.traces.contourcarpet.attributes.colorbar.title.font.variant
type ContourcarpetColorbarTitleFontVariant string

const (
	ContourcarpetColorbarTitleFontVariantNormal        ContourcarpetColorbarTitleFontVariant = "normal"
	ContourcarpetColorbarTitleFontVariantSmallCaps     ContourcarpetColorbarTitleFontVariant = "small-caps"
	ContourcarpetColorbarTitleFontVariantAllSmallCaps  ContourcarpetColorbarTitleFontVariant = "all-small-caps"
	ContourcarpetColorbarTitleFontVariantAllPetiteCaps ContourcarpetColorbarTitleFontVariant = "all-petite-caps"
	ContourcarpetColorbarTitleFontVariantPetiteCaps    ContourcarpetColorbarTitleFontVariant = "petite-caps"
	ContourcarpetColorbarTitleFontVariantUnicase       ContourcarpetColorbarTitleFontVariant = "unicase"
)

// ContourcarpetColorbarTitleSide Determines the location of color bar's title with respect to the color bar. Defaults to *top* when `orientation` if *v* and  defaults to *right* when `orientation` if *h*.
// .schema.traces.contourcarpet.attributes.colorbar.title.side
...
// ContourcarpetContoursLabelfontStyle Sets whether a font should be styled with a normal or italic face from its family.
// .schema.traces.contourcarpet.attributes.contours.labelfont.style
type ContourcarpetContoursLabelfontStyle string

const (
	ContourcarpetContoursLabelfontStyleNormal ContourcarpetContoursLabelfontStyle = "normal"
	ContourcarpetContoursLabelfontStyleItalic ContourcarpetContoursLabelfontStyle = "italic"
)

// ContourcarpetContoursLabelfontTextcase Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
// .schema.traces.contourcarpet.attributes.contours.labelfont.textcase
type ContourcarpetContoursLabelfontTextcase string

const (
	ContourcarpetContoursLabelfontTextcaseNormal   ContourcarpetContoursLabelfontTextcase = "normal"
	ContourcarpetContoursLabelfontTextcaseWordCaps ContourcarpetContoursLabelfontTextcase = "word caps"
	ContourcarpetContoursLabelfontTextcaseUpper    ContourcarpetContoursLabelfontTextcase = "upper"
	ContourcarpetContoursLabelfontTextcaseLower    ContourcarpetContoursLabelfontTextcase = "lower"
)

// ContourcarpetContoursLabelfontVariant Sets the variant of the font.
// .schema.traces.contourcarpet.attributes.contours.labelfont.variant
type ContourcarpetContoursLabelfontVariant string

const (
	ContourcarpetContoursLabelfontVariantNormal        ContourcarpetContoursLabelfontVariant = "normal"
	ContourcarpetContoursLabelfontVariantSmallCaps     ContourcarpetContoursLabelfontVariant = "small-caps"
	ContourcarpetContoursLabelfontVariantAllSmallCaps  ContourcarpetContoursLabelfontVariant = "all-small-caps"
	ContourcarpetContoursLabelfontVariantAllPetiteCaps ContourcarpetContoursLabelfontVariant = "all-petite-caps"
	ContourcarpetContoursLabelfontVariantPetiteCaps    ContourcarpetContoursLabelfontVariant = "petite-caps"
	ContourcarpetContoursLabelfontVariantUnicase       ContourcarpetContoursLabelfontVariant = "unicase"
)
...
// ContourcarpetLegendgrouptitleFontStyle Sets whether a font should be styled with a normal or italic face from its family.
// .schema.traces.contourcarpet.attributes.legendgrouptitle.font.style
type ContourcarpetLegendgrouptitleFontStyle string

const (
	ContourcarpetLegendgrouptitleFontStyleNormal ContourcarpetLegendgrouptitleFontStyle = "normal"
	ContourcarpetLegendgrouptitleFontStyleItalic ContourcarpetLegendgrouptitleFontStyle = "italic"
)

// ContourcarpetLegendgrouptitleFontTextcase Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
// .schema.traces.contourcarpet.attributes.legendgrouptitle.font.textcase
type ContourcarpetLegendgrouptitleFontTextcase string

const (
	ContourcarpetLegendgrouptitleFontTextcaseNormal   ContourcarpetLegendgrouptitleFontTextcase = "normal"
	ContourcarpetLegendgrouptitleFontTextcaseWordCaps ContourcarpetLegendgrouptitleFontTextcase = "word caps"
	ContourcarpetLegendgrouptitleFontTextcaseUpper    ContourcarpetLegendgrouptitleFontTextcase = "upper"
	ContourcarpetLegendgrouptitleFontTextcaseLower    ContourcarpetLegendgrouptitleFontTextcase = "lower"
)

// ContourcarpetLegendgrouptitleFontVariant Sets the variant of the font.
// .schema.traces.contourcarpet.attributes.legendgrouptitle.font.variant
type ContourcarpetLegendgrouptitleFontVariant string

const (
	ContourcarpetLegendgrouptitleFontVariantNormal        ContourcarpetLegendgrouptitleFontVariant = "normal"
	ContourcarpetLegendgrouptitleFontVariantSmallCaps     ContourcarpetLegendgrouptitleFontVariant = "small-caps"
	ContourcarpetLegendgrouptitleFontVariantAllSmallCaps  ContourcarpetLegendgrouptitleFontVariant = "all-small-caps"
	ContourcarpetLegendgrouptitleFontVariantAllPetiteCaps ContourcarpetLegendgrouptitleFontVariant = "all-petite-caps"
	ContourcarpetLegendgrouptitleFontVariantPetiteCaps    ContourcarpetLegendgrouptitleFontVariant = "petite-caps"
	ContourcarpetLegendgrouptitleFontVariantUnicase       ContourcarpetLegendgrouptitleFontVariant = "unicase"
)
...
// ContourcarpetColorbarTickfontLineposition Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
// .schema.traces.contourcarpet.attributes.colorbar.tickfont.lineposition
type ContourcarpetColorbarTickfontLineposition string

const (
	// Flags
	ContourcarpetColorbarTickfontLinepositionUnder   ContourcarpetColorbarTickfontLineposition = "under"
	ContourcarpetColorbarTickfontLinepositionOver    ContourcarpetColorbarTickfontLineposition = "over"
	ContourcarpetColorbarTickfontLinepositionThrough ContourcarpetColorbarTickfontLineposition = "through"

	// Extra
	ContourcarpetColorbarTickfontLinepositionNone ContourcarpetColorbarTickfontLineposition = "none"
)

// ContourcarpetColorbarTitleFontLineposition Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
// .schema.traces.contourcarpet.attributes.colorbar.title.font.lineposition
type ContourcarpetColorbarTitleFontLineposition string

const (
	// Flags
	ContourcarpetColorbarTitleFontLinepositionUnder   ContourcarpetColorbarTitleFontLineposition = "under"
	ContourcarpetColorbarTitleFontLinepositionOver    ContourcarpetColorbarTitleFontLineposition = "over"
	ContourcarpetColorbarTitleFontLinepositionThrough ContourcarpetColorbarTitleFontLineposition = "through"

	// Extra
	ContourcarpetColorbarTitleFontLinepositionNone ContourcarpetColorbarTitleFontLineposition = "none"
)

// ContourcarpetContoursLabelfontLineposition Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
// .schema.traces.contourcarpet.attributes.contours.labelfont.lineposition
type ContourcarpetContoursLabelfontLineposition string

const (
	// Flags
	ContourcarpetContoursLabelfontLinepositionUnder   ContourcarpetContoursLabelfontLineposition = "under"
	ContourcarpetContoursLabelfontLinepositionOver    ContourcarpetContoursLabelfontLineposition = "over"
	ContourcarpetContoursLabelfontLinepositionThrough ContourcarpetContoursLabelfontLineposition = "through"

	// Extra
	ContourcarpetContoursLabelfontLinepositionNone ContourcarpetContoursLabelfontLineposition = "none"
)

// ContourcarpetLegendgrouptitleFontLineposition Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
// .schema.traces.contourcarpet.attributes.legendgrouptitle.font.lineposition
type ContourcarpetLegendgrouptitleFontLineposition string

const (
	// Flags
	ContourcarpetLegendgrouptitleFontLinepositionUnder   ContourcarpetLegendgrouptitleFontLineposition = "under"
	ContourcarpetLegendgrouptitleFontLinepositionOver    ContourcarpetLegendgrouptitleFontLineposition = "over"
	ContourcarpetLegendgrouptitleFontLinepositionThrough ContourcarpetLegendgrouptitleFontLineposition = "through"

	// Extra
	ContourcarpetLegendgrouptitleFontLinepositionNone ContourcarpetLegendgrouptitleFontLineposition = "none"
)
