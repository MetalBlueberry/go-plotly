...
// SunburstMarkerColorbarTitleFont Sets this color bar's title font.
...
// SunburstMarkerColorbarTitleSide Determines the location of color bar's title with respect to the color bar. Defaults to *top* when `orientation` if *v* and  defaults to *right* when `orientation` if *h*.
// .schema.traces.sunburst.attributes.marker.colorbar.title.side
