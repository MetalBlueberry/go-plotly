...
type Mesh3dColorbarTickfont struct {
	...
	// .schema.traces.mesh3d.attributes.colorbar.tickfont.lineposition
	...
	// .schema.traces.mesh3d.attributes.colorbar.tickfont.shadow
	...
	// .schema.traces.mesh3d.attributes.colorbar.tickfont.style
	...
	// .schema.traces.mesh3d.attributes.colorbar.tickfont.textcase
	...
	// .schema.traces.mesh3d.attributes.colorbar.tickfont.variant
	...
	// .schema.traces.mesh3d.attributes.colorbar.tickfont.weight
...
// Mesh3dColorbarTitleFont Sets this color bar's title font.
type Mesh3dColorbarTitleFont struct {
	...
	// type: flaglist
	// Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
	// .schema.traces.mesh3d.attributes.colorbar.title.font.lineposition
	...
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.mesh3d.attributes.colorbar.title.font.shadow
	Shadow types.StringType `json:"shadow,omitempty"`
	...
	// type: enumerated
	// Sets whether a font should be styled with a normal or italic face from its family.
	// .schema.traces.mesh3d.attributes.colorbar.title.font.style
	...
	// type: enumerated
	// Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
	// .schema.traces.mesh3d.attributes.colorbar.title.font.textcase
	...
	// type: enumerated
	// Sets the variant of the font.
	// .schema.traces.mesh3d.attributes.colorbar.title.font.variant
	...
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.mesh3d.attributes.colorbar.title.font.weight
	Weight types.IntegerType `json:"weight,omitempty"`
}
...
type Mesh3dHoverlabelFont struct {
	...
	// type: flaglist
	// Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
	// .schema.traces.mesh3d.attributes.hoverlabel.font.lineposition
	...
	// .schema.traces.mesh3d.attributes.hoverlabel.font.linepositionsrc
	...
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.mesh3d.attributes.hoverlabel.font.shadow
	...
	// .schema.traces.mesh3d.attributes.hoverlabel.font.shadowsrc
	...
	// type: enumerated
	// Sets whether a font should be styled with a normal or italic face from its family.
	// .schema.traces.mesh3d.attributes.hoverlabel.font.style
	...
	// .schema.traces.mesh3d.attributes.hoverlabel.font.stylesrc
	...
	// type: enumerated
	// Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
	// .schema.traces.mesh3d.attributes.hoverlabel.font.textcase
	...
	// .schema.traces.mesh3d.attributes.hoverlabel.font.textcasesrc
	...
	// type: enumerated
	// Sets the variant of the font.
	// .schema.traces.mesh3d.attributes.hoverlabel.font.variant
	...
	// .schema.traces.mesh3d.attributes.hoverlabel.font.variantsrc
	...
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.mesh3d.attributes.hoverlabel.font.weight
	...
	// .schema.traces.mesh3d.attributes.hoverlabel.font.weightsrc
...
type Mesh3dLegendgrouptitleFont struct {
	...
	// type: flaglist
	// Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
	// .schema.traces.mesh3d.attributes.legendgrouptitle.font.lineposition
	...
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.mesh3d.attributes.legendgrouptitle.font.shadow
	Shadow types.StringType `json:"shadow,omitempty"`
	...
	// type: enumerated
	// Sets whether a font should be styled with a normal or italic face from its family.
	// .schema.traces.mesh3d.attributes.legendgrouptitle.font.style
	...
	// type: enumerated
	// Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
	// .schema.traces.mesh3d.attributes.legendgrouptitle.font.textcase
	...
	// type: enumerated
	// Sets the variant of the font.
	// .schema.traces.mesh3d.attributes.legendgrouptitle.font.variant
	...
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.mesh3d.attributes.legendgrouptitle.font.weight
	Weight types.IntegerType `json:"weight,omitempty"`
}
...
// Mesh3dColorbarTitleSide Determines the location of color bar's title with respect to the color bar. Defaults to *top* when `orientation` if *v* and  defaults to *right* when `orientation` if *h*.
// .schema.traces.mesh3d.attributes.colorbar.title.side
