...
// ContourColorbarTitleFont Sets this color bar's title font.
...
// ContourColorbarTitleSide Determines the location of color bar's title with respect to the color bar. Defaults to *top* when `orientation` if *v* and  defaults to *right* when `orientation` if *h*.
// .schema.traces.contour.attributes.colorbar.title.side
