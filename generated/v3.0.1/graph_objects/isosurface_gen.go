...
type IsosurfaceColorbarTickfont struct {
	...
	// .schema.traces.isosurface.attributes.colorbar.tickfont.lineposition
	Lineposition IsosurfaceColorbarTickfontLineposition `json:"lineposition,omitempty"`

	// Shadow
	// arrayOK: false
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.isosurface.attributes.colorbar.tickfont.shadow
	...
	// .schema.traces.isosurface.attributes.colorbar.tickfont.style
	Style IsosurfaceColorbarTickfontStyle `json:"style,omitempty"`
	...
	// .schema.traces.isosurface.attributes.colorbar.tickfont.textcase
	Textcase IsosurfaceColorbarTickfontTextcase `json:"textcase,omitempty"`
	...
	// .schema.traces.isosurface.attributes.colorbar.tickfont.variant
	Variant IsosurfaceColorbarTickfontVariant `json:"variant,omitempty"`

	// Weight
	// arrayOK: false
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.isosurface.attributes.colorbar.tickfont.weight
...
// IsosurfaceColorbarTitleFont Sets this color bar's title font.
type IsosurfaceColorbarTitleFont struct {
	...
	// type: flaglist
	// Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
	// .schema.traces.isosurface.attributes.colorbar.title.font.lineposition
	Lineposition IsosurfaceColorbarTitleFontLineposition `json:"lineposition,omitempty"`

	// Shadow
	// arrayOK: false
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.isosurface.attributes.colorbar.title.font.shadow
	Shadow types.StringType `json:"shadow,omitempty"`
	...
	// type: enumerated
	// Sets whether a font should be styled with a normal or italic face from its family.
	// .schema.traces.isosurface.attributes.colorbar.title.font.style
	Style IsosurfaceColorbarTitleFontStyle `json:"style,omitempty"`
	...
	// type: enumerated
	// Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
	// .schema.traces.isosurface.attributes.colorbar.title.font.textcase
	Textcase IsosurfaceColorbarTitleFontTextcase `json:"textcase,omitempty"`
	...
	// type: enumerated
	// Sets the variant of the font.
	// .schema.traces.isosurface.attributes.colorbar.title.font.variant
	Variant IsosurfaceColorbarTitleFontVariant `json:"variant,omitempty"`

	// Weight
	// arrayOK: false
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.isosurface.attributes.colorbar.title.font.weight
	Weight types.IntegerType `json:"weight,omitempty"`
}
...
type IsosurfaceHoverlabelFont struct {
	...
	// type: flaglist
	// Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
	// .schema.traces.isosurface.attributes.hoverlabel.font.lineposition
	Lineposition *types.ArrayOK[*IsosurfaceHoverlabelFontLineposition] `json:"lineposition,omitempty"`

	// Linepositionsrc
	// arrayOK: false
	// type: string
	// Sets the source reference on Chart Studio Cloud for `lineposition`.
	// .schema.traces.isosurface.attributes.hoverlabel.font.linepositionsrc
	...
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.isosurface.attributes.hoverlabel.font.shadow
	...
	// .schema.traces.isosurface.attributes.hoverlabel.font.shadowsrc
	...
	// type: enumerated
	// Sets whether a font should be styled with a normal or italic face from its family.
	// .schema.traces.isosurface.attributes.hoverlabel.font.style
	Style *types.ArrayOK[*IsosurfaceHoverlabelFontStyle] `json:"style,omitempty"`

	// Stylesrc
	// arrayOK: false
	// type: string
	// Sets the source reference on Chart Studio Cloud for `style`.
	// .schema.traces.isosurface.attributes.hoverlabel.font.stylesrc
	...
	// type: enumerated
	// Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
	// .schema.traces.isosurface.attributes.hoverlabel.font.textcase
	Textcase *types.ArrayOK[*IsosurfaceHoverlabelFontTextcase] `json:"textcase,omitempty"`

	// Textcasesrc
	// arrayOK: false
	// type: string
	// Sets the source reference on Chart Studio Cloud for `textcase`.
	// .schema.traces.isosurface.attributes.hoverlabel.font.textcasesrc
	...
	// type: enumerated
	// Sets the variant of the font.
	// .schema.traces.isosurface.attributes.hoverlabel.font.variant
	Variant *types.ArrayOK[*IsosurfaceHoverlabelFontVariant] `json:"variant,omitempty"`

	// Variantsrc
	// arrayOK: false
	// type: string
	// Sets the source reference on Chart Studio Cloud for `variant`.
	// .schema.traces.isosurface.attributes.hoverlabel.font.variantsrc
	...
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.isosurface.attributes.hoverlabel.font.weight
	...
	// .schema.traces.isosurface.attributes.hoverlabel.font.weightsrc
...
type IsosurfaceLegendgrouptitleFont struct {
	...
	// type: flaglist
	// Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
	// .schema.traces.isosurface.attributes.legendgrouptitle.font.lineposition
	Lineposition IsosurfaceLegendgrouptitleFontLineposition `json:"lineposition,omitempty"`

	// Shadow
	// arrayOK: false
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.isosurface.attributes.legendgrouptitle.font.shadow
	Shadow types.StringType `json:"shadow,omitempty"`
	...
	// type: enumerated
	// Sets whether a font should be styled with a normal or italic face from its family.
	// .schema.traces.isosurface.attributes.legendgrouptitle.font.style
	Style IsosurfaceLegendgrouptitleFontStyle `json:"style,omitempty"`
	...
	// type: enumerated
	// Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
	// .schema.traces.isosurface.attributes.legendgrouptitle.font.textcase
	Textcase IsosurfaceLegendgrouptitleFontTextcase `json:"textcase,omitempty"`
	...
	// type: enumerated
	// Sets the variant of the font.
	// .schema.traces.isosurface.attributes.legendgrouptitle.font.variant
	Variant IsosurfaceLegendgrouptitleFontVariant `json:"variant,omitempty"`

	// Weight
	// arrayOK: false
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.isosurface.attributes.legendgrouptitle.font.weight
	Weight types.IntegerType `json:"weight,omitempty"`
}
...
// IsosurfaceColorbarTickfontStyle Sets whether a font should be styled with a normal or italic face from its family.
// .schema.traces.isosurface.attributes.colorbar.tickfont.style
type IsosurfaceColorbarTickfontStyle string

const (
	IsosurfaceColorbarTickfontStyleNormal IsosurfaceColorbarTickfontStyle = "normal"
	IsosurfaceColorbarTickfontStyleItalic IsosurfaceColorbarTickfontStyle = "italic"
)

// IsosurfaceColorbarTickfontTextcase Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
// .schema.traces.isosurface.attributes.colorbar.tickfont.textcase
type IsosurfaceColorbarTickfontTextcase string

const (
	IsosurfaceColorbarTickfontTextcaseNormal   IsosurfaceColorbarTickfontTextcase = "normal"
	IsosurfaceColorbarTickfontTextcaseWordCaps IsosurfaceColorbarTickfontTextcase = "word caps"
	IsosurfaceColorbarTickfontTextcaseUpper    IsosurfaceColorbarTickfontTextcase = "upper"
	IsosurfaceColorbarTickfontTextcaseLower    IsosurfaceColorbarTickfontTextcase = "lower"
)

// IsosurfaceColorbarTickfontVariant Sets the variant of the font.
// .schema.traces.isosurface.attributes.colorbar.tickfont.variant
type IsosurfaceColorbarTickfontVariant string

const (
	IsosurfaceColorbarTickfontVariantNormal        IsosurfaceColorbarTickfontVariant = "normal"
	IsosurfaceColorbarTickfontVariantSmallCaps     IsosurfaceColorbarTickfontVariant = "small-caps"
	IsosurfaceColorbarTickfontVariantAllSmallCaps  IsosurfaceColorbarTickfontVariant = "all-small-caps"
	IsosurfaceColorbarTickfontVariantAllPetiteCaps IsosurfaceColorbarTickfontVariant = "all-petite-caps"
	IsosurfaceColorbarTickfontVariantPetiteCaps    IsosurfaceColorbarTickfontVariant = "petite-caps"
	IsosurfaceColorbarTickfontVariantUnicase       IsosurfaceColorbarTickfontVariant = "unicase"
)
...
// IsosurfaceColorbarTitleFontStyle Sets whether a font should be styled with a normal or italic face from its family.
// .schema.traces.isosurface.attributes.colorbar.title.font.style
type IsosurfaceColorbarTitleFontStyle string

const (
	IsosurfaceColorbarTitleFontStyleNormal IsosurfaceColorbarTitleFontStyle = "normal"
	IsosurfaceColorbarTitleFontStyleItalic IsosurfaceColorbarTitleFontStyle = "italic"
)

// IsosurfaceColorbarTitleFontTextcase Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
// .schema.traces.isosurface.attributes.colorbar.title.font.textcase
type IsosurfaceColorbarTitleFontTextcase string

const (
	IsosurfaceColorbarTitleFontTextcaseNormal   IsosurfaceColorbarTitleFontTextcase = "normal"
	IsosurfaceColorbarTitleFontTextcaseWordCaps IsosurfaceColorbarTitleFontTextcase = "word caps"
	IsosurfaceColorbarTitleFontTextcaseUpper    IsosurfaceColorbarTitleFontTextcase = "upper"
	IsosurfaceColorbarTitleFontTextcaseLower    IsosurfaceColorbarTitleFontTextcase = "lower"
)

// IsosurfaceColorbarTitleFontVariant Sets the variant of the font.
// .schema.traces.isosurface.attributes.colorbar.title.font.variant
type IsosurfaceColorbarTitleFontVariant string

const (
	IsosurfaceColorbarTitleFontVariantNormal        IsosurfaceColorbarTitleFontVariant = "normal"
	IsosurfaceColorbarTitleFontVariantSmallCaps     IsosurfaceColorbarTitleFontVariant = "small-caps"
	IsosurfaceColorbarTitleFontVariantAllSmallCaps  IsosurfaceColorbarTitleFontVariant = "all-small-caps"
	IsosurfaceColorbarTitleFontVariantAllPetiteCaps IsosurfaceColorbarTitleFontVariant = "all-petite-caps"
	IsosurfaceColorbarTitleFontVariantPetiteCaps    IsosurfaceColorbarTitleFontVariant = "petite-caps"
	IsosurfaceColorbarTitleFontVariantUnicase       IsosurfaceColorbarTitleFontVariant = "unicase"
)

// IsosurfaceColorbarTitleSide Determines the location of color bar's title with respect to the color bar. Defaults to *top* when `orientation` if *v* and  defaults to *right* when `orientation` if *h*.
// .schema.traces.isosurface.attributes.colorbar.title.side
...
// IsosurfaceHoverlabelFontStyle Sets whether a font should be styled with a normal or italic face from its family.
// .schema.traces.isosurface.attributes.hoverlabel.font.style
type IsosurfaceHoverlabelFontStyle string

const (
	IsosurfaceHoverlabelFontStyleNormal IsosurfaceHoverlabelFontStyle = "normal"
	IsosurfaceHoverlabelFontStyleItalic IsosurfaceHoverlabelFontStyle = "italic"
)

// IsosurfaceHoverlabelFontTextcase Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
// .schema.traces.isosurface.attributes.hoverlabel.font.textcase
type IsosurfaceHoverlabelFontTextcase string

const (
	IsosurfaceHoverlabelFontTextcaseNormal   IsosurfaceHoverlabelFontTextcase = "normal"
	IsosurfaceHoverlabelFontTextcaseWordCaps IsosurfaceHoverlabelFontTextcase = "word caps"
	IsosurfaceHoverlabelFontTextcaseUpper    IsosurfaceHoverlabelFontTextcase = "upper"
	IsosurfaceHoverlabelFontTextcaseLower    IsosurfaceHoverlabelFontTextcase = "lower"
)

// IsosurfaceHoverlabelFontVariant Sets the variant of the font.
// .schema.traces.isosurface.attributes.hoverlabel.font.variant
type IsosurfaceHoverlabelFontVariant string

const (
	IsosurfaceHoverlabelFontVariantNormal        IsosurfaceHoverlabelFontVariant = "normal"
	IsosurfaceHoverlabelFontVariantSmallCaps     IsosurfaceHoverlabelFontVariant = "small-caps"
	IsosurfaceHoverlabelFontVariantAllSmallCaps  IsosurfaceHoverlabelFontVariant = "all-small-caps"
	IsosurfaceHoverlabelFontVariantAllPetiteCaps IsosurfaceHoverlabelFontVariant = "all-petite-caps"
	IsosurfaceHoverlabelFontVariantPetiteCaps    IsosurfaceHoverlabelFontVariant = "petite-caps"
	IsosurfaceHoverlabelFontVariantUnicase       IsosurfaceHoverlabelFontVariant = "unicase"
)

// IsosurfaceLegendgrouptitleFontStyle Sets whether a font should be styled with a normal or italic face from its family.
// .schema.traces.isosurface.attributes.legendgrouptitle.font.style
type IsosurfaceLegendgrouptitleFontStyle string

const (
	IsosurfaceLegendgrouptitleFontStyleNormal IsosurfaceLegendgrouptitleFontStyle = "normal"
	IsosurfaceLegendgrouptitleFontStyleItalic IsosurfaceLegendgrouptitleFontStyle = "italic"
)

// IsosurfaceLegendgrouptitleFontTextcase Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
// .schema.traces.isosurface.attributes.legendgrouptitle.font.textcase
type IsosurfaceLegendgrouptitleFontTextcase string

const (
	IsosurfaceLegendgrouptitleFontTextcaseNormal   IsosurfaceLegendgrouptitleFontTextcase = "normal"
	IsosurfaceLegendgrouptitleFontTextcaseWordCaps IsosurfaceLegendgrouptitleFontTextcase = "word caps"
	IsosurfaceLegendgrouptitleFontTextcaseUpper    IsosurfaceLegendgrouptitleFontTextcase = "upper"
	IsosurfaceLegendgrouptitleFontTextcaseLower    IsosurfaceLegendgrouptitleFontTextcase = "lower"
)

// IsosurfaceLegendgrouptitleFontVariant Sets the variant of the font.
// .schema.traces.isosurface.attributes.legendgrouptitle.font.variant
type IsosurfaceLegendgrouptitleFontVariant string

const (
	IsosurfaceLegendgrouptitleFontVariantNormal        IsosurfaceLegendgrouptitleFontVariant = "normal"
	IsosurfaceLegendgrouptitleFontVariantSmallCaps     IsosurfaceLegendgrouptitleFontVariant = "small-caps"
	IsosurfaceLegendgrouptitleFontVariantAllSmallCaps  IsosurfaceLegendgrouptitleFontVariant = "all-small-caps"
	IsosurfaceLegendgrouptitleFontVariantAllPetiteCaps IsosurfaceLegendgrouptitleFontVariant = "all-petite-caps"
	IsosurfaceLegendgrouptitleFontVariantPetiteCaps    IsosurfaceLegendgrouptitleFontVariant = "petite-caps"
	IsosurfaceLegendgrouptitleFontVariantUnicase       IsosurfaceLegendgrouptitleFontVariant = "unicase"
)
...
// IsosurfaceColorbarTickfontLineposition Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
// .schema.traces.isosurface.attributes.colorbar.tickfont.lineposition
type IsosurfaceColorbarTickfontLineposition string

const (
	// Flags
	IsosurfaceColorbarTickfontLinepositionUnder   IsosurfaceColorbarTickfontLineposition = "under"
	IsosurfaceColorbarTickfontLinepositionOver    IsosurfaceColorbarTickfontLineposition = "over"
	IsosurfaceColorbarTickfontLinepositionThrough IsosurfaceColorbarTickfontLineposition = "through"

	// Extra
	IsosurfaceColorbarTickfontLinepositionNone IsosurfaceColorbarTickfontLineposition = "none"
)

// IsosurfaceColorbarTitleFontLineposition Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
// .schema.traces.isosurface.attributes.colorbar.title.font.lineposition
type IsosurfaceColorbarTitleFontLineposition string

const (
	// Flags
	IsosurfaceColorbarTitleFontLinepositionUnder   IsosurfaceColorbarTitleFontLineposition = "under"
	IsosurfaceColorbarTitleFontLinepositionOver    IsosurfaceColorbarTitleFontLineposition = "over"
	IsosurfaceColorbarTitleFontLinepositionThrough IsosurfaceColorbarTitleFontLineposition = "through"

	// Extra
	IsosurfaceColorbarTitleFontLinepositionNone IsosurfaceColorbarTitleFontLineposition = "none"
)
...
// IsosurfaceHoverlabelFontLineposition Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
// .schema.traces.isosurface.attributes.hoverlabel.font.lineposition
type IsosurfaceHoverlabelFontLineposition string

const (
	// Flags
	IsosurfaceHoverlabelFontLinepositionUnder   IsosurfaceHoverlabelFontLineposition = "under"
	IsosurfaceHoverlabelFontLinepositionOver    IsosurfaceHoverlabelFontLineposition = "over"
	IsosurfaceHoverlabelFontLinepositionThrough IsosurfaceHoverlabelFontLineposition = "through"

	// Extra
	IsosurfaceHoverlabelFontLinepositionNone IsosurfaceHoverlabelFontLineposition = "none"
)

// IsosurfaceLegendgrouptitleFontLineposition Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
// .schema.traces.isosurface.attributes.legendgrouptitle.font.lineposition
type IsosurfaceLegendgrouptitleFontLineposition string

const (
	// Flags
	IsosurfaceLegendgrouptitleFontLinepositionUnder   IsosurfaceLegendgrouptitleFontLineposition = "under"
	IsosurfaceLegendgrouptitleFontLinepositionOver    IsosurfaceLegendgrouptitleFontLineposition = "over"
	IsosurfaceLegendgrouptitleFontLinepositionThrough IsosurfaceLegendgrouptitleFontLineposition = "through"

	// Extra
	IsosurfaceLegendgrouptitleFontLinepositionNone IsosurfaceLegendgrouptitleFontLineposition = "none"
)
