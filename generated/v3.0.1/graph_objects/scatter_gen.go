...
type ScatterHoverlabelFont struct {
	...
	// .schema.traces.scatter.attributes.hoverlabel.font.lineposition
	Lineposition *types.ArrayOK[*ScatterHoverlabelFontLineposition] `json:"lineposition,omitempty"`

	// Linepositionsrc
	// arrayOK: false
	// type: string
	// Sets the source reference on Chart Studio Cloud for `lineposition`.
	// .schema.traces.scatter.attributes.hoverlabel.font.linepositionsrc
	...
	// .schema.traces.scatter.attributes.hoverlabel.font.shadow
	...
	// .schema.traces.scatter.attributes.hoverlabel.font.shadowsrc
	...
	// .schema.traces.scatter.attributes.hoverlabel.font.style
	Style *types.ArrayOK[*ScatterHoverlabelFontStyle] `json:"style,omitempty"`

	// Stylesrc
	// arrayOK: false
	// type: string
	// Sets the source reference on Chart Studio Cloud for `style`.
	// .schema.traces.scatter.attributes.hoverlabel.font.stylesrc
	...
	// .schema.traces.scatter.attributes.hoverlabel.font.textcase
	Textcase *types.ArrayOK[*ScatterHoverlabelFontTextcase] `json:"textcase,omitempty"`

	// Textcasesrc
	// arrayOK: false
	// type: string
	// Sets the source reference on Chart Studio Cloud for `textcase`.
	// .schema.traces.scatter.attributes.hoverlabel.font.textcasesrc
	...
	// .schema.traces.scatter.attributes.hoverlabel.font.variant
	Variant *types.ArrayOK[*ScatterHoverlabelFontVariant] `json:"variant,omitempty"`

	// Variantsrc
	// arrayOK: false
	// type: string
	// Sets the source reference on Chart Studio Cloud for `variant`.
	// .schema.traces.scatter.attributes.hoverlabel.font.variantsrc
	...
	// .schema.traces.scatter.attributes.hoverlabel.font.weight
	...
	// .schema.traces.scatter.attributes.hoverlabel.font.weightsrc
...
type ScatterLegendgrouptitleFont struct {
	...
	// type: flaglist
	// Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
	// .schema.traces.scatter.attributes.legendgrouptitle.font.lineposition
	Lineposition ScatterLegendgrouptitleFontLineposition `json:"lineposition,omitempty"`

	// Shadow
	// arrayOK: false
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.scatter.attributes.legendgrouptitle.font.shadow
	...
	// type: enumerated
	// Sets whether a font should be styled with a normal or italic face from its family.
	// .schema.traces.scatter.attributes.legendgrouptitle.font.style
	Style ScatterLegendgrouptitleFontStyle `json:"style,omitempty"`
	...
	// type: enumerated
	// Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
	// .schema.traces.scatter.attributes.legendgrouptitle.font.textcase
	Textcase ScatterLegendgrouptitleFontTextcase `json:"textcase,omitempty"`
	...
	// type: enumerated
	// Sets the variant of the font.
	// .schema.traces.scatter.attributes.legendgrouptitle.font.variant
	Variant ScatterLegendgrouptitleFontVariant `json:"variant,omitempty"`

	// Weight
	// arrayOK: false
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.scatter.attributes.legendgrouptitle.font.weight
...
type ScatterMarkerColorbarTickfont struct {
	...
	// type: flaglist
	// Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
	// .schema.traces.scatter.attributes.marker.colorbar.tickfont.lineposition
	Lineposition ScatterMarkerColorbarTickfontLineposition `json:"lineposition,omitempty"`

	// Shadow
	// arrayOK: false
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.scatter.attributes.marker.colorbar.tickfont.shadow
	Shadow types.StringType `json:"shadow,omitempty"`
	...
	// type: enumerated
	// Sets whether a font should be styled with a normal or italic face from its family.
	// .schema.traces.scatter.attributes.marker.colorbar.tickfont.style
	Style ScatterMarkerColorbarTickfontStyle `json:"style,omitempty"`
	...
	// type: enumerated
	// Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
	// .schema.traces.scatter.attributes.marker.colorbar.tickfont.textcase
	Textcase ScatterMarkerColorbarTickfontTextcase `json:"textcase,omitempty"`
	...
	// type: enumerated
	// Sets the variant of the font.
	// .schema.traces.scatter.attributes.marker.colorbar.tickfont.variant
	Variant ScatterMarkerColorbarTickfontVariant `json:"variant,omitempty"`

	// Weight
	// arrayOK: false
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.scatter.attributes.marker.colorbar.tickfont.weight
	Weight types.IntegerType `json:"weight,omitempty"`
}
...
// ScatterMarkerColorbarTitleFont Sets this color bar's title font.
type ScatterMarkerColorbarTitleFont struct {
	...
	// type: flaglist
	// Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
	// .schema.traces.scatter.attributes.marker.colorbar.title.font.lineposition
	Lineposition ScatterMarkerColorbarTitleFontLineposition `json:"lineposition,omitempty"`

	// Shadow
	// arrayOK: false
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.scatter.attributes.marker.colorbar.title.font.shadow
	Shadow types.StringType `json:"shadow,omitempty"`
	...
	// type: enumerated
	// Sets whether a font should be styled with a normal or italic face from its family.
	// .schema.traces.scatter.attributes.marker.colorbar.title.font.style
	Style ScatterMarkerColorbarTitleFontStyle `json:"style,omitempty"`
	...
	// type: enumerated
	// Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
	// .schema.traces.scatter.attributes.marker.colorbar.title.font.textcase
	Textcase ScatterMarkerColorbarTitleFontTextcase `json:"textcase,omitempty"`
	...
	// type: enumerated
	// Sets the variant of the font.
	// .schema.traces.scatter.attributes.marker.colorbar.title.font.variant
	Variant ScatterMarkerColorbarTitleFontVariant `json:"variant,omitempty"`

	// Weight
	// arrayOK: false
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.scatter.attributes.marker.colorbar.title.font.weight
	Weight types.IntegerType `json:"weight,omitempty"`
}
...
type ScatterTextfont struct {
	...
	// type: flaglist
	// Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
	// .schema.traces.scatter.attributes.textfont.lineposition
	Lineposition *types.ArrayOK[*ScatterTextfontLineposition] `json:"lineposition,omitempty"`

	// Linepositionsrc
	// arrayOK: false
	// type: string
	// Sets the source reference on Chart Studio Cloud for `lineposition`.
	// .schema.traces.scatter.attributes.textfont.linepositionsrc
	Linepositionsrc types.StringType `json:"linepositionsrc,omitempty"`
	...
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.scatter.attributes.textfont.shadow
	Shadow *types.ArrayOK[*types.StringType] `json:"shadow,omitempty"`
	...
	// type: string
	// Sets the source reference on Chart Studio Cloud for `shadow`.
	// .schema.traces.scatter.attributes.textfont.shadowsrc
	Shadowsrc types.StringType `json:"shadowsrc,omitempty"`
	...
	// type: enumerated
	// Sets whether a font should be styled with a normal or italic face from its family.
	// .schema.traces.scatter.attributes.textfont.style
	Style *types.ArrayOK[*ScatterTextfontStyle] `json:"style,omitempty"`

	// Stylesrc
	// arrayOK: false
	// type: string
	// Sets the source reference on Chart Studio Cloud for `style`.
	// .schema.traces.scatter.attributes.textfont.stylesrc
	Stylesrc types.StringType `json:"stylesrc,omitempty"`
	...
	// type: enumerated
	// Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
	// .schema.traces.scatter.attributes.textfont.textcase
	Textcase *types.ArrayOK[*ScatterTextfontTextcase] `json:"textcase,omitempty"`

	// Textcasesrc
	// arrayOK: false
	// type: string
	// Sets the source reference on Chart Studio Cloud for `textcase`.
	// .schema.traces.scatter.attributes.textfont.textcasesrc
	Textcasesrc types.StringType `json:"textcasesrc,omitempty"`
	...
	// type: enumerated
	// Sets the variant of the font.
	// .schema.traces.scatter.attributes.textfont.variant
	Variant *types.ArrayOK[*ScatterTextfontVariant] `json:"variant,omitempty"`

	// Variantsrc
	// arrayOK: false
	// type: string
	// Sets the source reference on Chart Studio Cloud for `variant`.
	// .schema.traces.scatter.attributes.textfont.variantsrc
	Variantsrc types.StringType `json:"variantsrc,omitempty"`
	...
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.scatter.attributes.textfont.weight
	Weight *types.ArrayOK[*types.IntegerType] `json:"weight,omitempty"`
	...
	// type: string
	// Sets the source reference on Chart Studio Cloud for `weight`.
	// .schema.traces.scatter.attributes.textfont.weightsrc
	Weightsrc types.StringType `json:"weightsrc,omitempty"`
}
...
// ScatterHoverlabelFontStyle Sets whether a font should be styled with a normal or italic face from its family.
// .schema.traces.scatter.attributes.hoverlabel.font.style
type ScatterHoverlabelFontStyle string

const (
	ScatterHoverlabelFontStyleNormal ScatterHoverlabelFontStyle = "normal"
	ScatterHoverlabelFontStyleItalic ScatterHoverlabelFontStyle = "italic"
)

// ScatterHoverlabelFontTextcase Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
// .schema.traces.scatter.attributes.hoverlabel.font.textcase
type ScatterHoverlabelFontTextcase string

const (
	ScatterHoverlabelFontTextcaseNormal   ScatterHoverlabelFontTextcase = "normal"
	ScatterHoverlabelFontTextcaseWordCaps ScatterHoverlabelFontTextcase = "word caps"
	ScatterHoverlabelFontTextcaseUpper    ScatterHoverlabelFontTextcase = "upper"
	ScatterHoverlabelFontTextcaseLower    ScatterHoverlabelFontTextcase = "lower"
)

// ScatterHoverlabelFontVariant Sets the variant of the font.
// .schema.traces.scatter.attributes.hoverlabel.font.variant
type ScatterHoverlabelFontVariant string

const (
	ScatterHoverlabelFontVariantNormal        ScatterHoverlabelFontVariant = "normal"
	ScatterHoverlabelFontVariantSmallCaps     ScatterHoverlabelFontVariant = "small-caps"
	ScatterHoverlabelFontVariantAllSmallCaps  ScatterHoverlabelFontVariant = "all-small-caps"
	ScatterHoverlabelFontVariantAllPetiteCaps ScatterHoverlabelFontVariant = "all-petite-caps"
	ScatterHoverlabelFontVariantPetiteCaps    ScatterHoverlabelFontVariant = "petite-caps"
	ScatterHoverlabelFontVariantUnicase       ScatterHoverlabelFontVariant = "unicase"
)

// ScatterLegendgrouptitleFontStyle Sets whether a font should be styled with a normal or italic face from its family.
// .schema.traces.scatter.attributes.legendgrouptitle.font.style
type ScatterLegendgrouptitleFontStyle string

const (
	ScatterLegendgrouptitleFontStyleNormal ScatterLegendgrouptitleFontStyle = "normal"
	ScatterLegendgrouptitleFontStyleItalic ScatterLegendgrouptitleFontStyle = "italic"
)

// ScatterLegendgrouptitleFontTextcase Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
// .schema.traces.scatter.attributes.legendgrouptitle.font.textcase
type ScatterLegendgrouptitleFontTextcase string

const (
	ScatterLegendgrouptitleFontTextcaseNormal   ScatterLegendgrouptitleFontTextcase = "normal"
	ScatterLegendgrouptitleFontTextcaseWordCaps ScatterLegendgrouptitleFontTextcase = "word caps"
	ScatterLegendgrouptitleFontTextcaseUpper    ScatterLegendgrouptitleFontTextcase = "upper"
	ScatterLegendgrouptitleFontTextcaseLower    ScatterLegendgrouptitleFontTextcase = "lower"
)

// ScatterLegendgrouptitleFontVariant Sets the variant of the font.
// .schema.traces.scatter.attributes.legendgrouptitle.font.variant
type ScatterLegendgrouptitleFontVariant string

const (
	ScatterLegendgrouptitleFontVariantNormal        ScatterLegendgrouptitleFontVariant = "normal"
	ScatterLegendgrouptitleFontVariantSmallCaps     ScatterLegendgrouptitleFontVariant = "small-caps"
	ScatterLegendgrouptitleFontVariantAllSmallCaps  ScatterLegendgrouptitleFontVariant = "all-small-caps"
	ScatterLegendgrouptitleFontVariantAllPetiteCaps ScatterLegendgrouptitleFontVariant = "all-petite-caps"
	ScatterLegendgrouptitleFontVariantPetiteCaps    ScatterLegendgrouptitleFontVariant = "petite-caps"
	ScatterLegendgrouptitleFontVariantUnicase       ScatterLegendgrouptitleFontVariant = "unicase"
)
...
// ScatterMarkerColorbarTickfontStyle Sets whether a font should be styled with a normal or italic face from its family.
// .schema.traces.scatter.attributes.marker.colorbar.tickfont.style
type ScatterMarkerColorbarTickfontStyle string

const (
	ScatterMarkerColorbarTickfontStyleNormal ScatterMarkerColorbarTickfontStyle = "normal"
	ScatterMarkerColorbarTickfontStyleItalic ScatterMarkerColorbarTickfontStyle = "italic"
)

// ScatterMarkerColorbarTickfontTextcase Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
// .schema.traces.scatter.attributes.marker.colorbar.tickfont.textcase
type ScatterMarkerColorbarTickfontTextcase string

const (
	ScatterMarkerColorbarTickfontTextcaseNormal   ScatterMarkerColorbarTickfontTextcase = "normal"
	ScatterMarkerColorbarTickfontTextcaseWordCaps ScatterMarkerColorbarTickfontTextcase = "word caps"
	ScatterMarkerColorbarTickfontTextcaseUpper    ScatterMarkerColorbarTickfontTextcase = "upper"
	ScatterMarkerColorbarTickfontTextcaseLower    ScatterMarkerColorbarTickfontTextcase = "lower"
)

// ScatterMarkerColorbarTickfontVariant Sets the variant of the font.
// .schema.traces.scatter.attributes.marker.colorbar.tickfont.variant
type ScatterMarkerColorbarTickfontVariant string

const (
	ScatterMarkerColorbarTickfontVariantNormal        ScatterMarkerColorbarTickfontVariant = "normal"
	ScatterMarkerColorbarTickfontVariantSmallCaps     ScatterMarkerColorbarTickfontVariant = "small-caps"
	ScatterMarkerColorbarTickfontVariantAllSmallCaps  ScatterMarkerColorbarTickfontVariant = "all-small-caps"
	ScatterMarkerColorbarTickfontVariantAllPetiteCaps ScatterMarkerColorbarTickfontVariant = "all-petite-caps"
	ScatterMarkerColorbarTickfontVariantPetiteCaps    ScatterMarkerColorbarTickfontVariant = "petite-caps"
	ScatterMarkerColorbarTickfontVariantUnicase       ScatterMarkerColorbarTickfontVariant = "unicase"
)
...
// ScatterMarkerColorbarTitleFontStyle Sets whether a font should be styled with a normal or italic face from its family.
// .schema.traces.scatter.attributes.marker.colorbar.title.font.style
type ScatterMarkerColorbarTitleFontStyle string

const (
	ScatterMarkerColorbarTitleFontStyleNormal ScatterMarkerColorbarTitleFontStyle = "normal"
	ScatterMarkerColorbarTitleFontStyleItalic ScatterMarkerColorbarTitleFontStyle = "italic"
)

// ScatterMarkerColorbarTitleFontTextcase Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
// .schema.traces.scatter.attributes.marker.colorbar.title.font.textcase
type ScatterMarkerColorbarTitleFontTextcase string

const (
	ScatterMarkerColorbarTitleFontTextcaseNormal   ScatterMarkerColorbarTitleFontTextcase = "normal"
	ScatterMarkerColorbarTitleFontTextcaseWordCaps ScatterMarkerColorbarTitleFontTextcase = "word caps"
	ScatterMarkerColorbarTitleFontTextcaseUpper    ScatterMarkerColorbarTitleFontTextcase = "upper"
	ScatterMarkerColorbarTitleFontTextcaseLower    ScatterMarkerColorbarTitleFontTextcase = "lower"
)

// ScatterMarkerColorbarTitleFontVariant Sets the variant of the font.
// .schema.traces.scatter.attributes.marker.colorbar.title.font.variant
type ScatterMarkerColorbarTitleFontVariant string

const (
	ScatterMarkerColorbarTitleFontVariantNormal        ScatterMarkerColorbarTitleFontVariant = "normal"
	ScatterMarkerColorbarTitleFontVariantSmallCaps     ScatterMarkerColorbarTitleFontVariant = "small-caps"
	ScatterMarkerColorbarTitleFontVariantAllSmallCaps  ScatterMarkerColorbarTitleFontVariant = "all-small-caps"
	ScatterMarkerColorbarTitleFontVariantAllPetiteCaps ScatterMarkerColorbarTitleFontVariant = "all-petite-caps"
	ScatterMarkerColorbarTitleFontVariantPetiteCaps    ScatterMarkerColorbarTitleFontVariant = "petite-caps"
	ScatterMarkerColorbarTitleFontVariantUnicase       ScatterMarkerColorbarTitleFontVariant = "unicase"
)

// ScatterMarkerColorbarTitleSide Determines the location of color bar's title with respect to the color bar. Defaults to *top* when `orientation` if *v* and  defaults to *right* when `orientation` if *h*.
// .schema.traces.scatter.attributes.marker.colorbar.title.side
...
// ScatterTextfontStyle Sets whether a font should be styled with a normal or italic face from its family.
// .schema.traces.scatter.attributes.textfont.style
type ScatterTextfontStyle string

const (
	ScatterTextfontStyleNormal ScatterTextfontStyle = "normal"
	ScatterTextfontStyleItalic ScatterTextfontStyle = "italic"
)

// ScatterTextfontTextcase Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
// .schema.traces.scatter.attributes.textfont.textcase
type ScatterTextfontTextcase string

const (
	ScatterTextfontTextcaseNormal   ScatterTextfontTextcase = "normal"
	ScatterTextfontTextcaseWordCaps ScatterTextfontTextcase = "word caps"
	ScatterTextfontTextcaseUpper    ScatterTextfontTextcase = "upper"
	ScatterTextfontTextcaseLower    ScatterTextfontTextcase = "lower"
)

// ScatterTextfontVariant Sets the variant of the font.
// .schema.traces.scatter.attributes.textfont.variant
type ScatterTextfontVariant string

const (
	ScatterTextfontVariantNormal        ScatterTextfontVariant = "normal"
	ScatterTextfontVariantSmallCaps     ScatterTextfontVariant = "small-caps"
	ScatterTextfontVariantAllSmallCaps  ScatterTextfontVariant = "all-small-caps"
	ScatterTextfontVariantAllPetiteCaps ScatterTextfontVariant = "all-petite-caps"
	ScatterTextfontVariantPetiteCaps    ScatterTextfontVariant = "petite-caps"
	ScatterTextfontVariantUnicase       ScatterTextfontVariant = "unicase"
)
...
// ScatterHoverlabelFontLineposition Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
// .schema.traces.scatter.attributes.hoverlabel.font.lineposition
type ScatterHoverlabelFontLineposition string

const (
	// Flags
	ScatterHoverlabelFontLinepositionUnder   ScatterHoverlabelFontLineposition = "under"
	ScatterHoverlabelFontLinepositionOver    ScatterHoverlabelFontLineposition = "over"
	ScatterHoverlabelFontLinepositionThrough ScatterHoverlabelFontLineposition = "through"

	// Extra
	ScatterHoverlabelFontLinepositionNone ScatterHoverlabelFontLineposition = "none"
)
...
// ScatterLegendgrouptitleFontLineposition Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
// .schema.traces.scatter.attributes.legendgrouptitle.font.lineposition
type ScatterLegendgrouptitleFontLineposition string

const (
	// Flags
	ScatterLegendgrouptitleFontLinepositionUnder   ScatterLegendgrouptitleFontLineposition = "under"
	ScatterLegendgrouptitleFontLinepositionOver    ScatterLegendgrouptitleFontLineposition = "over"
	ScatterLegendgrouptitleFontLinepositionThrough ScatterLegendgrouptitleFontLineposition = "through"

	// Extra
	ScatterLegendgrouptitleFontLinepositionNone ScatterLegendgrouptitleFontLineposition = "none"
)

// ScatterMarkerColorbarTickfontLineposition Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
// .schema.traces.scatter.attributes.marker.colorbar.tickfont.lineposition
type ScatterMarkerColorbarTickfontLineposition string

const (
	// Flags
	ScatterMarkerColorbarTickfontLinepositionUnder   ScatterMarkerColorbarTickfontLineposition = "under"
	ScatterMarkerColorbarTickfontLinepositionOver    ScatterMarkerColorbarTickfontLineposition = "over"
	ScatterMarkerColorbarTickfontLinepositionThrough ScatterMarkerColorbarTickfontLineposition = "through"

	// Extra
	ScatterMarkerColorbarTickfontLinepositionNone ScatterMarkerColorbarTickfontLineposition = "none"
)

// ScatterMarkerColorbarTitleFontLineposition Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
// .schema.traces.scatter.attributes.marker.colorbar.title.font.lineposition
type ScatterMarkerColorbarTitleFontLineposition string

const (
	// Flags
	ScatterMarkerColorbarTitleFontLinepositionUnder   ScatterMarkerColorbarTitleFontLineposition = "under"
	ScatterMarkerColorbarTitleFontLinepositionOver    ScatterMarkerColorbarTitleFontLineposition = "over"
	ScatterMarkerColorbarTitleFontLinepositionThrough ScatterMarkerColorbarTitleFontLineposition = "through"

	// Extra
	ScatterMarkerColorbarTitleFontLinepositionNone ScatterMarkerColorbarTitleFontLineposition = "none"
)
...
// ScatterTextfontLineposition Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
// .schema.traces.scatter.attributes.textfont.lineposition
type ScatterTextfontLineposition string

const (
	// Flags
	ScatterTextfontLinepositionUnder   ScatterTextfontLineposition = "under"
	ScatterTextfontLinepositionOver    ScatterTextfontLineposition = "over"
	ScatterTextfontLinepositionThrough ScatterTextfontLineposition = "through"

	// Extra
	ScatterTextfontLinepositionNone ScatterTextfontLineposition = "none"
)
