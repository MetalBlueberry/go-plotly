...
type Choropleth struct {
	...
	// .schema.traces.choropleth.attributes.autocolorscale
	...
	// .schema.traces.choropleth.attributes.coloraxis
	Coloraxis types.StringType `json:"coloraxis,omitempty"`

	// Colorbar
	// arrayOK: false
	// role: Object
	// .schema.traces.choropleth.attributes.colorbar
	...
	// .schema.traces.choropleth.attributes.colorscale
	...
	// .schema.traces.choropleth.attributes.customdata
	...
	// .schema.traces.choropleth.attributes.customdatasrc
	...
	// .schema.traces.choropleth.attributes.featureidkey
	...
	// .schema.traces.choropleth.attributes.geo
	...
	// .schema.traces.choropleth.attributes.geojson
	...
	// .schema.traces.choropleth.attributes.hoverinfo
	...
	// .schema.traces.choropleth.attributes.hoverinfosrc
	Hoverinfosrc types.StringType `json:"hoverinfosrc,omitempty"`

	// Hoverlabel
	// arrayOK: false
	// role: Object
	// .schema.traces.choropleth.attributes.hoverlabel
	...
	// .schema.traces.choropleth.attributes.hovertemplate
	...
	// .schema.traces.choropleth.attributes.hovertemplatesrc
	...
	// type: string
	// Same as `text`.
	// .schema.traces.choropleth.attributes.hovertext
	...
	// .schema.traces.choropleth.attributes.hovertextsrc
	...
	// use types.DataArray to pass any slice of data
	// use types.BDataArray to pass data in binary format as provided by numpy
	// .schema.traces.choropleth.attributes.ids
	...
	// .schema.traces.choropleth.attributes.idssrc
	...
	// .schema.traces.choropleth.attributes.legend
	...
	// .schema.traces.choropleth.attributes.legendgroup
	Legendgroup types.StringType `json:"legendgroup,omitempty"`

	// Legendgrouptitle
	// arrayOK: false
	// role: Object
	// .schema.traces.choropleth.attributes.legendgrouptitle
	...
	// .schema.traces.choropleth.attributes.legendrank
	...
	// .schema.traces.choropleth.attributes.legendwidth
	...
	// .schema.traces.choropleth.attributes.locationmode
	...
	// use types.DataArray to pass any slice of data
	// use types.BDataArray to pass data in binary format as provided by numpy
	// .schema.traces.choropleth.attributes.locations
	...
	// .schema.traces.choropleth.attributes.locationssrc
	Locationssrc types.StringType `json:"locationssrc,omitempty"`

	// Marker
	// arrayOK: false
	// role: Object
	// .schema.traces.choropleth.attributes.marker
	...
	// .schema.traces.choropleth.attributes.meta
	...
	// .schema.traces.choropleth.attributes.metasrc
	...
	// .schema.traces.choropleth.attributes.name
	...
	// .schema.traces.choropleth.attributes.reversescale
	Reversescale types.BoolType `json:"reversescale,omitempty"`

	// Selected
	// arrayOK: false
	// role: Object
	// .schema.traces.choropleth.attributes.selected
	...
	// .schema.traces.choropleth.attributes.selectedpoints
	...
	// .schema.traces.choropleth.attributes.showlegend
	...
	// .schema.traces.choropleth.attributes.showscale
	Showscale types.BoolType `json:"showscale,omitempty"`

	// Stream
	// arrayOK: false
	// role: Object
	// .schema.traces.choropleth.attributes.stream
	...
	// .schema.traces.choropleth.attributes.text
	...
	// .schema.traces.choropleth.attributes.textsrc
	...
	// .schema.traces.choropleth.attributes.uid
	...
	// .schema.traces.choropleth.attributes.uirevision
	Uirevision interface{} `json:"uirevision,omitempty"`

	// Unselected
	// arrayOK: false
	// role: Object
	// .schema.traces.choropleth.attributes.unselected
	...
	// .schema.traces.choropleth.attributes.visible
	...
	// use types.DataArray to pass any slice of data
	// use types.BDataArray to pass data in binary format as provided by numpy
	// .schema.traces.choropleth.attributes.z
	...
	// .schema.traces.choropleth.attributes.zauto
	...
	// .schema.traces.choropleth.attributes.zmax
	...
	// .schema.traces.choropleth.attributes.zmid
	...
	// .schema.traces.choropleth.attributes.zmin
	...
	// .schema.traces.choropleth.attributes.zsrc
...
type ChoroplethColorbarTickfont struct {
	...
	// type: color
	//
	// .schema.traces.choropleth.attributes.colorbar.tickfont.color
	...
	// .schema.traces.choropleth.attributes.colorbar.tickfont.family
	...
	// .schema.traces.choropleth.attributes.colorbar.tickfont.lineposition
	...
	// .schema.traces.choropleth.attributes.colorbar.tickfont.shadow
	...
	// type: number
	//
	// .schema.traces.choropleth.attributes.colorbar.tickfont.size
	...
	// .schema.traces.choropleth.attributes.colorbar.tickfont.style
	...
	// .schema.traces.choropleth.attributes.colorbar.tickfont.textcase
	...
	// .schema.traces.choropleth.attributes.colorbar.tickfont.variant
	...
	// .schema.traces.choropleth.attributes.colorbar.tickfont.weight
...
type ChoroplethColorbarTickformatstop struct {
	...
	// .schema.traces.choropleth.attributes.colorbar.tickformatstops.items.tickformatstop.dtickrange
	...
	// .schema.traces.choropleth.attributes.colorbar.tickformatstops.items.tickformatstop.enabled
	...
	// .schema.traces.choropleth.attributes.colorbar.tickformatstops.items.tickformatstop.name
	Name types.StringType `json:"name,omitempty"`
	...
	// .schema.traces.choropleth.attributes.colorbar.tickformatstops.items.tickformatstop.templateitemname
	...
	// .schema.traces.choropleth.attributes.colorbar.tickformatstops.items.tickformatstop.value
	Value types.StringType `json:"value,omitempty"`
}

// ChoroplethColorbarTitleFont Sets this color bar's title font.
type ChoroplethColorbarTitleFont struct {
	...
	// type: color
	//
	// .schema.traces.choropleth.attributes.colorbar.title.font.color
	Color types.Color `json:"color,omitempty"`
	...
	// type: string
	// HTML font family - the typeface that will be applied by the web browser. The web browser will only be able to apply a font if it is available on the system which it operates. Provide multiple font families, separated by commas, to indicate the preference in which to apply fonts if they aren't available on the system. The Chart Studio Cloud (at https://chart-studio.plotly.com or on-premise) generates images on a server, where only a select number of fonts are installed and supported. These include *Arial*, *Balto*, *Courier New*, *Droid Sans*, *Droid Serif*, *Droid Sans Mono*, *Gravitas One*, *Old Standard TT*, *Open Sans*, *Overpass*, *PT Sans Narrow*, *Raleway*, *Times New Roman*.
	// .schema.traces.choropleth.attributes.colorbar.title.font.family
	Family types.StringType `json:"family,omitempty"`
	...
	// type: flaglist
	// Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
	// .schema.traces.choropleth.attributes.colorbar.title.font.lineposition
	...
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.choropleth.attributes.colorbar.title.font.shadow
	Shadow types.StringType `json:"shadow,omitempty"`
	...
	// type: number
	//
	// .schema.traces.choropleth.attributes.colorbar.title.font.size
	Size types.NumberType `json:"size,omitempty"`
	...
	// type: enumerated
	// Sets whether a font should be styled with a normal or italic face from its family.
	// .schema.traces.choropleth.attributes.colorbar.title.font.style
	...
	// type: enumerated
	// Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
	// .schema.traces.choropleth.attributes.colorbar.title.font.textcase
	...
	// type: enumerated
	// Sets the variant of the font.
	// .schema.traces.choropleth.attributes.colorbar.title.font.variant
	...
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.choropleth.attributes.colorbar.title.font.weight
	Weight types.IntegerType `json:"weight,omitempty"`
}
...
type ChoroplethColorbarTitle struct {
	...
	// arrayOK: false
	// role: Object
	// .schema.traces.choropleth.attributes.colorbar.title.font
	...
	// .schema.traces.choropleth.attributes.colorbar.title.side
	...
	// .schema.traces.choropleth.attributes.colorbar.title.text
...
type ChoroplethColorbar struct {
	...
	// .schema.traces.choropleth.attributes.colorbar.bgcolor
	...
	// .schema.traces.choropleth.attributes.colorbar.bordercolor
	...
	// .schema.traces.choropleth.attributes.colorbar.borderwidth
	...
	// .schema.traces.choropleth.attributes.colorbar.dtick
	...
	// .schema.traces.choropleth.attributes.colorbar.exponentformat
	...
	// .schema.traces.choropleth.attributes.colorbar.labelalias
	...
	// .schema.traces.choropleth.attributes.colorbar.len
	...
	// .schema.traces.choropleth.attributes.colorbar.lenmode
	...
	// .schema.traces.choropleth.attributes.colorbar.minexponent
	...
	// .schema.traces.choropleth.attributes.colorbar.nticks
	...
	// .schema.traces.choropleth.attributes.colorbar.orientation
	...
	// type: color
	// Sets the axis line color.
	// .schema.traces.choropleth.attributes.colorbar.outlinecolor
	...
	// .schema.traces.choropleth.attributes.colorbar.outlinewidth
	...
	// .schema.traces.choropleth.attributes.colorbar.separatethousands
	...
	// .schema.traces.choropleth.attributes.colorbar.showexponent
	...
	// .schema.traces.choropleth.attributes.colorbar.showticklabels
	...
	// .schema.traces.choropleth.attributes.colorbar.showtickprefix
	...
	// .schema.traces.choropleth.attributes.colorbar.showticksuffix
	...
	// .schema.traces.choropleth.attributes.colorbar.thickness
	...
	// .schema.traces.choropleth.attributes.colorbar.thicknessmode
	...
	// .schema.traces.choropleth.attributes.colorbar.tick0
	...
	// .schema.traces.choropleth.attributes.colorbar.tickangle
	...
	// type: color
	// Sets the tick color.
	// .schema.traces.choropleth.attributes.colorbar.tickcolor
	Tickcolor types.Color `json:"tickcolor,omitempty"`

	// Tickfont
	// arrayOK: false
	// role: Object
	// .schema.traces.choropleth.attributes.colorbar.tickfont
	...
	// .schema.traces.choropleth.attributes.colorbar.tickformat
	Tickformat types.StringType `json:"tickformat,omitempty"`

	// Tickformatstops
	// role: Object
	// items: ChoroplethColorbarTickformatstop
	// .schema.traces.choropleth.attributes.colorbar.tickformatstops
	...
	// .schema.traces.choropleth.attributes.colorbar.ticklabeloverflow
	...
	// .schema.traces.choropleth.attributes.colorbar.ticklabelposition
	...
	// .schema.traces.choropleth.attributes.colorbar.ticklabelstep
	...
	// .schema.traces.choropleth.attributes.colorbar.ticklen
	...
	// .schema.traces.choropleth.attributes.colorbar.tickmode
	...
	// .schema.traces.choropleth.attributes.colorbar.tickprefix
	...
	// .schema.traces.choropleth.attributes.colorbar.ticks
	...
	// .schema.traces.choropleth.attributes.colorbar.ticksuffix
	...
	// use types.DataArray to pass any slice of data
	// use types.BDataArray to pass data in binary format as provided by numpy
	// .schema.traces.choropleth.attributes.colorbar.ticktext
	...
	// .schema.traces.choropleth.attributes.colorbar.ticktextsrc
	...
	// use types.DataArray to pass any slice of data
	// use types.BDataArray to pass data in binary format as provided by numpy
	// .schema.traces.choropleth.attributes.colorbar.tickvals
	...
	// .schema.traces.choropleth.attributes.colorbar.tickvalssrc
	...
	// .schema.traces.choropleth.attributes.colorbar.tickwidth
	Tickwidth types.NumberType `json:"tickwidth,omitempty"`

	// Title
	// arrayOK: false
	// role: Object
	// .schema.traces.choropleth.attributes.colorbar.title
	...
	// .schema.traces.choropleth.attributes.colorbar.x
	...
	// .schema.traces.choropleth.attributes.colorbar.xanchor
	...
	// .schema.traces.choropleth.attributes.colorbar.xpad
	...
	// .schema.traces.choropleth.attributes.colorbar.xref
	...
	// .schema.traces.choropleth.attributes.colorbar.y
	...
	// .schema.traces.choropleth.attributes.colorbar.yanchor
	...
	// .schema.traces.choropleth.attributes.colorbar.ypad
	...
	// .schema.traces.choropleth.attributes.colorbar.yref
...
type ChoroplethHoverlabelFont struct {
	...
	// type: color
	//
	// .schema.traces.choropleth.attributes.hoverlabel.font.color
	...
	// .schema.traces.choropleth.attributes.hoverlabel.font.colorsrc
	...
	// type: string
	// HTML font family - the typeface that will be applied by the web browser. The web browser will only be able to apply a font if it is available on the system which it operates. Provide multiple font families, separated by commas, to indicate the preference in which to apply fonts if they aren't available on the system. The Chart Studio Cloud (at https://chart-studio.plotly.com or on-premise) generates images on a server, where only a select number of fonts are installed and supported. These include *Arial*, *Balto*, *Courier New*, *Droid Sans*, *Droid Serif*, *Droid Sans Mono*, *Gravitas One*, *Old Standard TT*, *Open Sans*, *Overpass*, *PT Sans Narrow*, *Raleway*, *Times New Roman*.
	// .schema.traces.choropleth.attributes.hoverlabel.font.family
	...
	// .schema.traces.choropleth.attributes.hoverlabel.font.familysrc
	...
	// type: flaglist
	// Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
	// .schema.traces.choropleth.attributes.hoverlabel.font.lineposition
	...
	// .schema.traces.choropleth.attributes.hoverlabel.font.linepositionsrc
	...
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.choropleth.attributes.hoverlabel.font.shadow
	...
	// .schema.traces.choropleth.attributes.hoverlabel.font.shadowsrc
	...
	// type: number
	//
	// .schema.traces.choropleth.attributes.hoverlabel.font.size
	...
	// .schema.traces.choropleth.attributes.hoverlabel.font.sizesrc
	...
	// type: enumerated
	// Sets whether a font should be styled with a normal or italic face from its family.
	// .schema.traces.choropleth.attributes.hoverlabel.font.style
	...
	// .schema.traces.choropleth.attributes.hoverlabel.font.stylesrc
	...
	// type: enumerated
	// Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
	// .schema.traces.choropleth.attributes.hoverlabel.font.textcase
	...
	// .schema.traces.choropleth.attributes.hoverlabel.font.textcasesrc
	...
	// type: enumerated
	// Sets the variant of the font.
	// .schema.traces.choropleth.attributes.hoverlabel.font.variant
	...
	// .schema.traces.choropleth.attributes.hoverlabel.font.variantsrc
	...
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.choropleth.attributes.hoverlabel.font.weight
	...
	// .schema.traces.choropleth.attributes.hoverlabel.font.weightsrc
...
type ChoroplethHoverlabel struct {
	...
	// .schema.traces.choropleth.attributes.hoverlabel.align
	...
	// .schema.traces.choropleth.attributes.hoverlabel.alignsrc
	...
	// .schema.traces.choropleth.attributes.hoverlabel.bgcolor
	...
	// .schema.traces.choropleth.attributes.hoverlabel.bgcolorsrc
	...
	// .schema.traces.choropleth.attributes.hoverlabel.bordercolor
	...
	// .schema.traces.choropleth.attributes.hoverlabel.bordercolorsrc
	Bordercolorsrc types.StringType `json:"bordercolorsrc,omitempty"`

	// Font
	// arrayOK: false
	// role: Object
	// .schema.traces.choropleth.attributes.hoverlabel.font
	...
	// .schema.traces.choropleth.attributes.hoverlabel.namelength
	...
	// .schema.traces.choropleth.attributes.hoverlabel.namelengthsrc
...
type ChoroplethLegendgrouptitleFont struct {
	...
	// type: color
	//
	// .schema.traces.choropleth.attributes.legendgrouptitle.font.color
	Color types.Color `json:"color,omitempty"`
	...
	// type: string
	// HTML font family - the typeface that will be applied by the web browser. The web browser will only be able to apply a font if it is available on the system which it operates. Provide multiple font families, separated by commas, to indicate the preference in which to apply fonts if they aren't available on the system. The Chart Studio Cloud (at https://chart-studio.plotly.com or on-premise) generates images on a server, where only a select number of fonts are installed and supported. These include *Arial*, *Balto*, *Courier New*, *Droid Sans*, *Droid Serif*, *Droid Sans Mono*, *Gravitas One*, *Old Standard TT*, *Open Sans*, *Overpass*, *PT Sans Narrow*, *Raleway*, *Times New Roman*.
	// .schema.traces.choropleth.attributes.legendgrouptitle.font.family
	Family types.StringType `json:"family,omitempty"`
	...
	// type: flaglist
	// Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
	// .schema.traces.choropleth.attributes.legendgrouptitle.font.lineposition
	...
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.choropleth.attributes.legendgrouptitle.font.shadow
	Shadow types.StringType `json:"shadow,omitempty"`
	...
	// type: number
	//
	// .schema.traces.choropleth.attributes.legendgrouptitle.font.size
	Size types.NumberType `json:"size,omitempty"`
	...
	// type: enumerated
	// Sets whether a font should be styled with a normal or italic face from its family.
	// .schema.traces.choropleth.attributes.legendgrouptitle.font.style
	...
	// type: enumerated
	// Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
	// .schema.traces.choropleth.attributes.legendgrouptitle.font.textcase
	...
	// type: enumerated
	// Sets the variant of the font.
	// .schema.traces.choropleth.attributes.legendgrouptitle.font.variant
	...
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.choropleth.attributes.legendgrouptitle.font.weight
	Weight types.IntegerType `json:"weight,omitempty"`
}
...
type ChoroplethLegendgrouptitle struct {
	...
	// arrayOK: false
	// role: Object
	// .schema.traces.choropleth.attributes.legendgrouptitle.font
	...
	// .schema.traces.choropleth.attributes.legendgrouptitle.text
	Text types.StringType `json:"text,omitempty"`
}
...
type ChoroplethMarkerLine struct {
	...
	// .schema.traces.choropleth.attributes.marker.line.color
	Color *types.ArrayOK[*types.Color] `json:"color,omitempty"`
	...
	// type: string
	// Sets the source reference on Chart Studio Cloud for `color`.
	// .schema.traces.choropleth.attributes.marker.line.colorsrc
	Colorsrc types.StringType `json:"colorsrc,omitempty"`
	...
	// .schema.traces.choropleth.attributes.marker.line.width
	...
	// .schema.traces.choropleth.attributes.marker.line.widthsrc
...
type ChoroplethMarker struct {
	...
	// arrayOK: false
	// role: Object
	// .schema.traces.choropleth.attributes.marker.line
	...
	// .schema.traces.choropleth.attributes.marker.opacity
	...
	// .schema.traces.choropleth.attributes.marker.opacitysrc
...
type ChoroplethSelectedMarker struct {
	...
	// .schema.traces.choropleth.attributes.selected.marker.opacity
...
type ChoroplethSelected struct {
	...
	// arrayOK: false
	// role: Object
	// .schema.traces.choropleth.attributes.selected.marker
...
type ChoroplethStream struct {
	...
	// .schema.traces.choropleth.attributes.stream.maxpoints
	...
	// .schema.traces.choropleth.attributes.stream.token
...
type ChoroplethUnselectedMarker struct {
	...
	// .schema.traces.choropleth.attributes.unselected.marker.opacity
	Opacity types.NumberType `json:"opacity,omitempty"`
}
...
type ChoroplethUnselected struct {
	...
	// arrayOK: false
	// role: Object
	// .schema.traces.choropleth.attributes.unselected.marker
...
// ChoroplethColorbarTitleSide Determines the location of color bar's title with respect to the color bar. Defaults to *top* when `orientation` if *v* and  defaults to *right* when `orientation` if *h*.
// .schema.traces.choropleth.attributes.colorbar.title.side
