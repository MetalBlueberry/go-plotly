...
type ParcatsLabelfont struct {
	...
	// .schema.traces.parcats.attributes.labelfont.lineposition
	Lineposition ParcatsLabelfontLineposition `json:"lineposition,omitempty"`

	// Shadow
	// arrayOK: false
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.parcats.attributes.labelfont.shadow
	...
	// .schema.traces.parcats.attributes.labelfont.style
	Style ParcatsLabelfontStyle `json:"style,omitempty"`
	...
	// .schema.traces.parcats.attributes.labelfont.textcase
	Textcase ParcatsLabelfontTextcase `json:"textcase,omitempty"`
	...
	// .schema.traces.parcats.attributes.labelfont.variant
	Variant ParcatsLabelfontVariant `json:"variant,omitempty"`

	// Weight
	// arrayOK: false
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.parcats.attributes.labelfont.weight
...
type ParcatsLegendgrouptitleFont struct {
	...
	// type: flaglist
	// Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
	// .schema.traces.parcats.attributes.legendgrouptitle.font.lineposition
	Lineposition ParcatsLegendgrouptitleFontLineposition `json:"lineposition,omitempty"`

	// Shadow
	// arrayOK: false
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.parcats.attributes.legendgrouptitle.font.shadow
	Shadow types.StringType `json:"shadow,omitempty"`
	...
	// type: enumerated
	// Sets whether a font should be styled with a normal or italic face from its family.
	// .schema.traces.parcats.attributes.legendgrouptitle.font.style
	Style ParcatsLegendgrouptitleFontStyle `json:"style,omitempty"`
	...
	// type: enumerated
	// Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
	// .schema.traces.parcats.attributes.legendgrouptitle.font.textcase
	Textcase ParcatsLegendgrouptitleFontTextcase `json:"textcase,omitempty"`
	...
	// type: enumerated
	// Sets the variant of the font.
	// .schema.traces.parcats.attributes.legendgrouptitle.font.variant
	Variant ParcatsLegendgrouptitleFontVariant `json:"variant,omitempty"`

	// Weight
	// arrayOK: false
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.parcats.attributes.legendgrouptitle.font.weight
	Weight types.IntegerType `json:"weight,omitempty"`
}
...
type ParcatsLineColorbarTickfont struct {
	...
	// type: flaglist
	// Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
	// .schema.traces.parcats.attributes.line.colorbar.tickfont.lineposition
	Lineposition ParcatsLineColorbarTickfontLineposition `json:"lineposition,omitempty"`

	// Shadow
	// arrayOK: false
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.parcats.attributes.line.colorbar.tickfont.shadow
	Shadow types.StringType `json:"shadow,omitempty"`
	...
	// type: enumerated
	// Sets whether a font should be styled with a normal or italic face from its family.
	// .schema.traces.parcats.attributes.line.colorbar.tickfont.style
	Style ParcatsLineColorbarTickfontStyle `json:"style,omitempty"`
	...
	// type: enumerated
	// Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
	// .schema.traces.parcats.attributes.line.colorbar.tickfont.textcase
	Textcase ParcatsLineColorbarTickfontTextcase `json:"textcase,omitempty"`
	...
	// type: enumerated
	// Sets the variant of the font.
	// .schema.traces.parcats.attributes.line.colorbar.tickfont.variant
	Variant ParcatsLineColorbarTickfontVariant `json:"variant,omitempty"`

	// Weight
	// arrayOK: false
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.parcats.attributes.line.colorbar.tickfont.weight
	Weight types.IntegerType `json:"weight,omitempty"`
}
...
// ParcatsLineColorbarTitleFont Sets this color bar's title font.
type ParcatsLineColorbarTitleFont struct {
	...
	// type: flaglist
	// Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
	// .schema.traces.parcats.attributes.line.colorbar.title.font.lineposition
	Lineposition ParcatsLineColorbarTitleFontLineposition `json:"lineposition,omitempty"`

	// Shadow
	// arrayOK: false
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.parcats.attributes.line.colorbar.title.font.shadow
	Shadow types.StringType `json:"shadow,omitempty"`
	...
	// type: enumerated
	// Sets whether a font should be styled with a normal or italic face from its family.
	// .schema.traces.parcats.attributes.line.colorbar.title.font.style
	Style ParcatsLineColorbarTitleFontStyle `json:"style,omitempty"`
	...
	// type: enumerated
	// Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
	// .schema.traces.parcats.attributes.line.colorbar.title.font.textcase
	Textcase ParcatsLineColorbarTitleFontTextcase `json:"textcase,omitempty"`
	...
	// type: enumerated
	// Sets the variant of the font.
	// .schema.traces.parcats.attributes.line.colorbar.title.font.variant
	Variant ParcatsLineColorbarTitleFontVariant `json:"variant,omitempty"`

	// Weight
	// arrayOK: false
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.parcats.attributes.line.colorbar.title.font.weight
	Weight types.IntegerType `json:"weight,omitempty"`
}
...
type ParcatsLineColorbar struct {
	...
	// .schema.traces.parcats.attributes.line.colorbar.xref
	Xref ParcatsLineColorbarXref `json:"xref,omitempty"`
	...
	// .schema.traces.parcats.attributes.line.colorbar.yref
	Yref ParcatsLineColorbarYref `json:"yref,omitempty"`
}
...
type ParcatsTickfont struct {
	...
	// type: flaglist
	// Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
	// .schema.traces.parcats.attributes.tickfont.lineposition
	Lineposition ParcatsTickfontLineposition `json:"lineposition,omitempty"`

	// Shadow
	// arrayOK: false
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.parcats.attributes.tickfont.shadow
	Shadow types.StringType `json:"shadow,omitempty"`
	...
	// type: enumerated
	// Sets whether a font should be styled with a normal or italic face from its family.
	// .schema.traces.parcats.attributes.tickfont.style
	Style ParcatsTickfontStyle `json:"style,omitempty"`
	...
	// type: enumerated
	// Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
	// .schema.traces.parcats.attributes.tickfont.textcase
	Textcase ParcatsTickfontTextcase `json:"textcase,omitempty"`
	...
	// type: enumerated
	// Sets the variant of the font.
	// .schema.traces.parcats.attributes.tickfont.variant
	Variant ParcatsTickfontVariant `json:"variant,omitempty"`

	// Weight
	// arrayOK: false
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.parcats.attributes.tickfont.weight
	Weight types.IntegerType `json:"weight,omitempty"`
}
...
// ParcatsLabelfontStyle Sets whether a font should be styled with a normal or italic face from its family.
// .schema.traces.parcats.attributes.labelfont.style
type ParcatsLabelfontStyle string

const (
	ParcatsLabelfontStyleNormal ParcatsLabelfontStyle = "normal"
	ParcatsLabelfontStyleItalic ParcatsLabelfontStyle = "italic"
)

// ParcatsLabelfontTextcase Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
// .schema.traces.parcats.attributes.labelfont.textcase
type ParcatsLabelfontTextcase string

const (
	ParcatsLabelfontTextcaseNormal   ParcatsLabelfontTextcase = "normal"
	ParcatsLabelfontTextcaseWordCaps ParcatsLabelfontTextcase = "word caps"
	ParcatsLabelfontTextcaseUpper    ParcatsLabelfontTextcase = "upper"
	ParcatsLabelfontTextcaseLower    ParcatsLabelfontTextcase = "lower"
)

// ParcatsLabelfontVariant Sets the variant of the font.
// .schema.traces.parcats.attributes.labelfont.variant
type ParcatsLabelfontVariant string

const (
	ParcatsLabelfontVariantNormal        ParcatsLabelfontVariant = "normal"
	ParcatsLabelfontVariantSmallCaps     ParcatsLabelfontVariant = "small-caps"
	ParcatsLabelfontVariantAllSmallCaps  ParcatsLabelfontVariant = "all-small-caps"
	ParcatsLabelfontVariantAllPetiteCaps ParcatsLabelfontVariant = "all-petite-caps"
	ParcatsLabelfontVariantPetiteCaps    ParcatsLabelfontVariant = "petite-caps"
	ParcatsLabelfontVariantUnicase       ParcatsLabelfontVariant = "unicase"
)

// ParcatsLegendgrouptitleFontStyle Sets whether a font should be styled with a normal or italic face from its family.
// .schema.traces.parcats.attributes.legendgrouptitle.font.style
type ParcatsLegendgrouptitleFontStyle string

const (
	ParcatsLegendgrouptitleFontStyleNormal ParcatsLegendgrouptitleFontStyle = "normal"
	ParcatsLegendgrouptitleFontStyleItalic ParcatsLegendgrouptitleFontStyle = "italic"
)

// ParcatsLegendgrouptitleFontTextcase Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
// .schema.traces.parcats.attributes.legendgrouptitle.font.textcase
type ParcatsLegendgrouptitleFontTextcase string

const (
	ParcatsLegendgrouptitleFontTextcaseNormal   ParcatsLegendgrouptitleFontTextcase = "normal"
	ParcatsLegendgrouptitleFontTextcaseWordCaps ParcatsLegendgrouptitleFontTextcase = "word caps"
	ParcatsLegendgrouptitleFontTextcaseUpper    ParcatsLegendgrouptitleFontTextcase = "upper"
	ParcatsLegendgrouptitleFontTextcaseLower    ParcatsLegendgrouptitleFontTextcase = "lower"
)

// ParcatsLegendgrouptitleFontVariant Sets the variant of the font.
// .schema.traces.parcats.attributes.legendgrouptitle.font.variant
type ParcatsLegendgrouptitleFontVariant string

const (
	ParcatsLegendgrouptitleFontVariantNormal        ParcatsLegendgrouptitleFontVariant = "normal"
	ParcatsLegendgrouptitleFontVariantSmallCaps     ParcatsLegendgrouptitleFontVariant = "small-caps"
	ParcatsLegendgrouptitleFontVariantAllSmallCaps  ParcatsLegendgrouptitleFontVariant = "all-small-caps"
	ParcatsLegendgrouptitleFontVariantAllPetiteCaps ParcatsLegendgrouptitleFontVariant = "all-petite-caps"
	ParcatsLegendgrouptitleFontVariantPetiteCaps    ParcatsLegendgrouptitleFontVariant = "petite-caps"
	ParcatsLegendgrouptitleFontVariantUnicase       ParcatsLegendgrouptitleFontVariant = "unicase"
)
...
// ParcatsLineColorbarTickfontStyle Sets whether a font should be styled with a normal or italic face from its family.
// .schema.traces.parcats.attributes.line.colorbar.tickfont.style
type ParcatsLineColorbarTickfontStyle string

const (
	ParcatsLineColorbarTickfontStyleNormal ParcatsLineColorbarTickfontStyle = "normal"
	ParcatsLineColorbarTickfontStyleItalic ParcatsLineColorbarTickfontStyle = "italic"
)

// ParcatsLineColorbarTickfontTextcase Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
// .schema.traces.parcats.attributes.line.colorbar.tickfont.textcase
type ParcatsLineColorbarTickfontTextcase string

const (
	ParcatsLineColorbarTickfontTextcaseNormal   ParcatsLineColorbarTickfontTextcase = "normal"
	ParcatsLineColorbarTickfontTextcaseWordCaps ParcatsLineColorbarTickfontTextcase = "word caps"
	ParcatsLineColorbarTickfontTextcaseUpper    ParcatsLineColorbarTickfontTextcase = "upper"
	ParcatsLineColorbarTickfontTextcaseLower    ParcatsLineColorbarTickfontTextcase = "lower"
)

// ParcatsLineColorbarTickfontVariant Sets the variant of the font.
// .schema.traces.parcats.attributes.line.colorbar.tickfont.variant
type ParcatsLineColorbarTickfontVariant string

const (
	ParcatsLineColorbarTickfontVariantNormal        ParcatsLineColorbarTickfontVariant = "normal"
	ParcatsLineColorbarTickfontVariantSmallCaps     ParcatsLineColorbarTickfontVariant = "small-caps"
	ParcatsLineColorbarTickfontVariantAllSmallCaps  ParcatsLineColorbarTickfontVariant = "all-small-caps"
	ParcatsLineColorbarTickfontVariantAllPetiteCaps ParcatsLineColorbarTickfontVariant = "all-petite-caps"
	ParcatsLineColorbarTickfontVariantPetiteCaps    ParcatsLineColorbarTickfontVariant = "petite-caps"
	ParcatsLineColorbarTickfontVariantUnicase       ParcatsLineColorbarTickfontVariant = "unicase"
)
...
// ParcatsLineColorbarTitleFontStyle Sets whether a font should be styled with a normal or italic face from its family.
// .schema.traces.parcats.attributes.line.colorbar.title.font.style
type ParcatsLineColorbarTitleFontStyle string

const (
	ParcatsLineColorbarTitleFontStyleNormal ParcatsLineColorbarTitleFontStyle = "normal"
	ParcatsLineColorbarTitleFontStyleItalic ParcatsLineColorbarTitleFontStyle = "italic"
)

// ParcatsLineColorbarTitleFontTextcase Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
// .schema.traces.parcats.attributes.line.colorbar.title.font.textcase
type ParcatsLineColorbarTitleFontTextcase string

const (
	ParcatsLineColorbarTitleFontTextcaseNormal   ParcatsLineColorbarTitleFontTextcase = "normal"
	ParcatsLineColorbarTitleFontTextcaseWordCaps ParcatsLineColorbarTitleFontTextcase = "word caps"
	ParcatsLineColorbarTitleFontTextcaseUpper    ParcatsLineColorbarTitleFontTextcase = "upper"
	ParcatsLineColorbarTitleFontTextcaseLower    ParcatsLineColorbarTitleFontTextcase = "lower"
)

// ParcatsLineColorbarTitleFontVariant Sets the variant of the font.
// .schema.traces.parcats.attributes.line.colorbar.title.font.variant
type ParcatsLineColorbarTitleFontVariant string

const (
	ParcatsLineColorbarTitleFontVariantNormal        ParcatsLineColorbarTitleFontVariant = "normal"
	ParcatsLineColorbarTitleFontVariantSmallCaps     ParcatsLineColorbarTitleFontVariant = "small-caps"
	ParcatsLineColorbarTitleFontVariantAllSmallCaps  ParcatsLineColorbarTitleFontVariant = "all-small-caps"
	ParcatsLineColorbarTitleFontVariantAllPetiteCaps ParcatsLineColorbarTitleFontVariant = "all-petite-caps"
	ParcatsLineColorbarTitleFontVariantPetiteCaps    ParcatsLineColorbarTitleFontVariant = "petite-caps"
	ParcatsLineColorbarTitleFontVariantUnicase       ParcatsLineColorbarTitleFontVariant = "unicase"
)

// ParcatsLineColorbarTitleSide Determines the location of color bar's title with respect to the color bar. Defaults to *top* when `orientation` if *v* and  defaults to *right* when `orientation` if *h*.
// .schema.traces.parcats.attributes.line.colorbar.title.side
...
// ParcatsLineColorbarXref Sets the container `x` refers to. *container* spans the entire `width` of the plot. *paper* refers to the width of the plotting area only.
// .schema.traces.parcats.attributes.line.colorbar.xref
type ParcatsLineColorbarXref string

const (
	ParcatsLineColorbarXrefContainer ParcatsLineColorbarXref = "container"
	ParcatsLineColorbarXrefPaper     ParcatsLineColorbarXref = "paper"
)
...
// ParcatsLineColorbarYref Sets the container `y` refers to. *container* spans the entire `height` of the plot. *paper* refers to the height of the plotting area only.
// .schema.traces.parcats.attributes.line.colorbar.yref
type ParcatsLineColorbarYref string

const (
	ParcatsLineColorbarYrefContainer ParcatsLineColorbarYref = "container"
	ParcatsLineColorbarYrefPaper     ParcatsLineColorbarYref = "paper"
)
...
// ParcatsTickfontStyle Sets whether a font should be styled with a normal or italic face from its family.
// .schema.traces.parcats.attributes.tickfont.style
type ParcatsTickfontStyle string

const (
	ParcatsTickfontStyleNormal ParcatsTickfontStyle = "normal"
	ParcatsTickfontStyleItalic ParcatsTickfontStyle = "italic"
)

// ParcatsTickfontTextcase Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
// .schema.traces.parcats.attributes.tickfont.textcase
type ParcatsTickfontTextcase string

const (
	ParcatsTickfontTextcaseNormal   ParcatsTickfontTextcase = "normal"
	ParcatsTickfontTextcaseWordCaps ParcatsTickfontTextcase = "word caps"
	ParcatsTickfontTextcaseUpper    ParcatsTickfontTextcase = "upper"
	ParcatsTickfontTextcaseLower    ParcatsTickfontTextcase = "lower"
)

// ParcatsTickfontVariant Sets the variant of the font.
// .schema.traces.parcats.attributes.tickfont.variant
type ParcatsTickfontVariant string

const (
	ParcatsTickfontVariantNormal        ParcatsTickfontVariant = "normal"
	ParcatsTickfontVariantSmallCaps     ParcatsTickfontVariant = "small-caps"
	ParcatsTickfontVariantAllSmallCaps  ParcatsTickfontVariant = "all-small-caps"
	ParcatsTickfontVariantAllPetiteCaps ParcatsTickfontVariant = "all-petite-caps"
	ParcatsTickfontVariantPetiteCaps    ParcatsTickfontVariant = "petite-caps"
	ParcatsTickfontVariantUnicase       ParcatsTickfontVariant = "unicase"
)
...
// ParcatsLabelfontLineposition Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
// .schema.traces.parcats.attributes.labelfont.lineposition
type ParcatsLabelfontLineposition string

const (
	// Flags
	ParcatsLabelfontLinepositionUnder   ParcatsLabelfontLineposition = "under"
	ParcatsLabelfontLinepositionOver    ParcatsLabelfontLineposition = "over"
	ParcatsLabelfontLinepositionThrough ParcatsLabelfontLineposition = "through"

	// Extra
	ParcatsLabelfontLinepositionNone ParcatsLabelfontLineposition = "none"
)

// ParcatsLegendgrouptitleFontLineposition Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
// .schema.traces.parcats.attributes.legendgrouptitle.font.lineposition
type ParcatsLegendgrouptitleFontLineposition string

const (
	// Flags
	ParcatsLegendgrouptitleFontLinepositionUnder   ParcatsLegendgrouptitleFontLineposition = "under"
	ParcatsLegendgrouptitleFontLinepositionOver    ParcatsLegendgrouptitleFontLineposition = "over"
	ParcatsLegendgrouptitleFontLinepositionThrough ParcatsLegendgrouptitleFontLineposition = "through"

	// Extra
	ParcatsLegendgrouptitleFontLinepositionNone ParcatsLegendgrouptitleFontLineposition = "none"
)

// ParcatsLineColorbarTickfontLineposition Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
// .schema.traces.parcats.attributes.line.colorbar.tickfont.lineposition
type ParcatsLineColorbarTickfontLineposition string

const (
	// Flags
	ParcatsLineColorbarTickfontLinepositionUnder   ParcatsLineColorbarTickfontLineposition = "under"
	ParcatsLineColorbarTickfontLinepositionOver    ParcatsLineColorbarTickfontLineposition = "over"
	ParcatsLineColorbarTickfontLinepositionThrough ParcatsLineColorbarTickfontLineposition = "through"

	// Extra
	ParcatsLineColorbarTickfontLinepositionNone ParcatsLineColorbarTickfontLineposition = "none"
)

// ParcatsLineColorbarTitleFontLineposition Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
// .schema.traces.parcats.attributes.line.colorbar.title.font.lineposition
type ParcatsLineColorbarTitleFontLineposition string

const (
	// Flags
	ParcatsLineColorbarTitleFontLinepositionUnder   ParcatsLineColorbarTitleFontLineposition = "under"
	ParcatsLineColorbarTitleFontLinepositionOver    ParcatsLineColorbarTitleFontLineposition = "over"
	ParcatsLineColorbarTitleFontLinepositionThrough ParcatsLineColorbarTitleFontLineposition = "through"

	// Extra
	ParcatsLineColorbarTitleFontLinepositionNone ParcatsLineColorbarTitleFontLineposition = "none"
)

// ParcatsTickfontLineposition Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
// .schema.traces.parcats.attributes.tickfont.lineposition
type ParcatsTickfontLineposition string

const (
	// Flags
	ParcatsTickfontLinepositionUnder   ParcatsTickfontLineposition = "under"
	ParcatsTickfontLinepositionOver    ParcatsTickfontLineposition = "over"
	ParcatsTickfontLinepositionThrough ParcatsTickfontLineposition = "through"

	// Extra
	ParcatsTickfontLinepositionNone ParcatsTickfontLineposition = "none"
)
