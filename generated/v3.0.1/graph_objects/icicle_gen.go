...
// IcicleMarkerColorbarTitleFont Sets this color bar's title font.
...
// IcicleMarkerColorbarTitleSide Determines the location of color bar's title with respect to the color bar. Defaults to *top* when `orientation` if *v* and  defaults to *right* when `orientation` if *h*.
// .schema.traces.icicle.attributes.marker.colorbar.title.side
