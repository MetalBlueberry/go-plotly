...
type Volume struct {
	...
	// .schema.traces.volume.attributes.legend
...
type VolumeColorbarTickfont struct {
	...
	// .schema.traces.volume.attributes.colorbar.tickfont.lineposition
	Lineposition VolumeColorbarTickfontLineposition `json:"lineposition,omitempty"`

	// Shadow
	// arrayOK: false
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.volume.attributes.colorbar.tickfont.shadow
	...
	// .schema.traces.volume.attributes.colorbar.tickfont.style
	Style VolumeColorbarTickfontStyle `json:"style,omitempty"`
	...
	// .schema.traces.volume.attributes.colorbar.tickfont.textcase
	Textcase VolumeColorbarTickfontTextcase `json:"textcase,omitempty"`
	...
	// .schema.traces.volume.attributes.colorbar.tickfont.variant
	Variant VolumeColorbarTickfontVariant `json:"variant,omitempty"`

	// Weight
	// arrayOK: false
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.volume.attributes.colorbar.tickfont.weight
	Weight types.IntegerType `json:"weight,omitempty"`
}

// VolumeColorbarTickformatstop
type VolumeColorbarTickformatstop struct {
...
// VolumeColorbarTitleFont Sets this color bar's title font.
type VolumeColorbarTitleFont struct {
	...
	// type: flaglist
	// Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
	// .schema.traces.volume.attributes.colorbar.title.font.lineposition
	Lineposition VolumeColorbarTitleFontLineposition `json:"lineposition,omitempty"`

	// Shadow
	// arrayOK: false
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.volume.attributes.colorbar.title.font.shadow
	Shadow types.StringType `json:"shadow,omitempty"`
	...
	// type: enumerated
	// Sets whether a font should be styled with a normal or italic face from its family.
	// .schema.traces.volume.attributes.colorbar.title.font.style
	Style VolumeColorbarTitleFontStyle `json:"style,omitempty"`
	...
	// type: enumerated
	// Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
	// .schema.traces.volume.attributes.colorbar.title.font.textcase
	Textcase VolumeColorbarTitleFontTextcase `json:"textcase,omitempty"`
	...
	// type: enumerated
	// Sets the variant of the font.
	// .schema.traces.volume.attributes.colorbar.title.font.variant
	Variant VolumeColorbarTitleFontVariant `json:"variant,omitempty"`

	// Weight
	// arrayOK: false
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.volume.attributes.colorbar.title.font.weight
	Weight types.IntegerType `json:"weight,omitempty"`
}
...
type VolumeColorbar struct {
	...
	// .schema.traces.volume.attributes.colorbar.xref
	...
	// .schema.traces.volume.attributes.colorbar.yref
...
type VolumeHoverlabelFont struct {
	...
	// type: flaglist
	// Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
	// .schema.traces.volume.attributes.hoverlabel.font.lineposition
	Lineposition *types.ArrayOK[*VolumeHoverlabelFontLineposition] `json:"lineposition,omitempty"`

	// Linepositionsrc
	// arrayOK: false
	// type: string
	// Sets the source reference on Chart Studio Cloud for `lineposition`.
	// .schema.traces.volume.attributes.hoverlabel.font.linepositionsrc
	...
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.volume.attributes.hoverlabel.font.shadow
	...
	// .schema.traces.volume.attributes.hoverlabel.font.shadowsrc
	...
	// type: enumerated
	// Sets whether a font should be styled with a normal or italic face from its family.
	// .schema.traces.volume.attributes.hoverlabel.font.style
	Style *types.ArrayOK[*VolumeHoverlabelFontStyle] `json:"style,omitempty"`

	// Stylesrc
	// arrayOK: false
	// type: string
	// Sets the source reference on Chart Studio Cloud for `style`.
	// .schema.traces.volume.attributes.hoverlabel.font.stylesrc
	...
	// type: enumerated
	// Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
	// .schema.traces.volume.attributes.hoverlabel.font.textcase
	Textcase *types.ArrayOK[*VolumeHoverlabelFontTextcase] `json:"textcase,omitempty"`

	// Textcasesrc
	// arrayOK: false
	// type: string
	// Sets the source reference on Chart Studio Cloud for `textcase`.
	// .schema.traces.volume.attributes.hoverlabel.font.textcasesrc
	...
	// type: enumerated
	// Sets the variant of the font.
	// .schema.traces.volume.attributes.hoverlabel.font.variant
	Variant *types.ArrayOK[*VolumeHoverlabelFontVariant] `json:"variant,omitempty"`

	// Variantsrc
	// arrayOK: false
	// type: string
	// Sets the source reference on Chart Studio Cloud for `variant`.
	// .schema.traces.volume.attributes.hoverlabel.font.variantsrc
	...
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.volume.attributes.hoverlabel.font.weight
	...
	// .schema.traces.volume.attributes.hoverlabel.font.weightsrc
...
type VolumeLegendgrouptitleFont struct {
	...
	// type: flaglist
	// Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
	// .schema.traces.volume.attributes.legendgrouptitle.font.lineposition
	Lineposition VolumeLegendgrouptitleFontLineposition `json:"lineposition,omitempty"`

	// Shadow
	// arrayOK: false
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.volume.attributes.legendgrouptitle.font.shadow
	Shadow types.StringType `json:"shadow,omitempty"`
	...
	// type: enumerated
	// Sets whether a font should be styled with a normal or italic face from its family.
	// .schema.traces.volume.attributes.legendgrouptitle.font.style
	Style VolumeLegendgrouptitleFontStyle `json:"style,omitempty"`
	...
	// type: enumerated
	// Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
	// .schema.traces.volume.attributes.legendgrouptitle.font.textcase
	Textcase VolumeLegendgrouptitleFontTextcase `json:"textcase,omitempty"`
	...
	// type: enumerated
	// Sets the variant of the font.
	// .schema.traces.volume.attributes.legendgrouptitle.font.variant
	Variant VolumeLegendgrouptitleFontVariant `json:"variant,omitempty"`

	// Weight
	// arrayOK: false
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.volume.attributes.legendgrouptitle.font.weight
	Weight types.IntegerType `json:"weight,omitempty"`
}
...
// VolumeColorbarTickfontStyle Sets whether a font should be styled with a normal or italic face from its family.
// .schema.traces.volume.attributes.colorbar.tickfont.style
type VolumeColorbarTickfontStyle string

const (
	VolumeColorbarTickfontStyleNormal VolumeColorbarTickfontStyle = "normal"
	VolumeColorbarTickfontStyleItalic VolumeColorbarTickfontStyle = "italic"
)

// VolumeColorbarTickfontTextcase Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
// .schema.traces.volume.attributes.colorbar.tickfont.textcase
type VolumeColorbarTickfontTextcase string

const (
	VolumeColorbarTickfontTextcaseNormal   VolumeColorbarTickfontTextcase = "normal"
	VolumeColorbarTickfontTextcaseWordCaps VolumeColorbarTickfontTextcase = "word caps"
	VolumeColorbarTickfontTextcaseUpper    VolumeColorbarTickfontTextcase = "upper"
	VolumeColorbarTickfontTextcaseLower    VolumeColorbarTickfontTextcase = "lower"
)

// VolumeColorbarTickfontVariant Sets the variant of the font.
// .schema.traces.volume.attributes.colorbar.tickfont.variant
type VolumeColorbarTickfontVariant string

const (
	VolumeColorbarTickfontVariantNormal        VolumeColorbarTickfontVariant = "normal"
	VolumeColorbarTickfontVariantSmallCaps     VolumeColorbarTickfontVariant = "small-caps"
	VolumeColorbarTickfontVariantAllSmallCaps  VolumeColorbarTickfontVariant = "all-small-caps"
	VolumeColorbarTickfontVariantAllPetiteCaps VolumeColorbarTickfontVariant = "all-petite-caps"
	VolumeColorbarTickfontVariantPetiteCaps    VolumeColorbarTickfontVariant = "petite-caps"
	VolumeColorbarTickfontVariantUnicase       VolumeColorbarTickfontVariant = "unicase"
)
...
// VolumeColorbarTitleFontStyle Sets whether a font should be styled with a normal or italic face from its family.
// .schema.traces.volume.attributes.colorbar.title.font.style
type VolumeColorbarTitleFontStyle string

const (
	VolumeColorbarTitleFontStyleNormal VolumeColorbarTitleFontStyle = "normal"
	VolumeColorbarTitleFontStyleItalic VolumeColorbarTitleFontStyle = "italic"
)

// VolumeColorbarTitleFontTextcase Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
// .schema.traces.volume.attributes.colorbar.title.font.textcase
type VolumeColorbarTitleFontTextcase string

const (
	VolumeColorbarTitleFontTextcaseNormal   VolumeColorbarTitleFontTextcase = "normal"
	VolumeColorbarTitleFontTextcaseWordCaps VolumeColorbarTitleFontTextcase = "word caps"
	VolumeColorbarTitleFontTextcaseUpper    VolumeColorbarTitleFontTextcase = "upper"
	VolumeColorbarTitleFontTextcaseLower    VolumeColorbarTitleFontTextcase = "lower"
)

// VolumeColorbarTitleFontVariant Sets the variant of the font.
// .schema.traces.volume.attributes.colorbar.title.font.variant
type VolumeColorbarTitleFontVariant string

const (
	VolumeColorbarTitleFontVariantNormal        VolumeColorbarTitleFontVariant = "normal"
	VolumeColorbarTitleFontVariantSmallCaps     VolumeColorbarTitleFontVariant = "small-caps"
	VolumeColorbarTitleFontVariantAllSmallCaps  VolumeColorbarTitleFontVariant = "all-small-caps"
	VolumeColorbarTitleFontVariantAllPetiteCaps VolumeColorbarTitleFontVariant = "all-petite-caps"
	VolumeColorbarTitleFontVariantPetiteCaps    VolumeColorbarTitleFontVariant = "petite-caps"
	VolumeColorbarTitleFontVariantUnicase       VolumeColorbarTitleFontVariant = "unicase"
)

// VolumeColorbarTitleSide Determines the location of color bar's title with respect to the color bar. Defaults to *top* when `orientation` if *v* and  defaults to *right* when `orientation` if *h*.
// .schema.traces.volume.attributes.colorbar.title.side
...
// VolumeHoverlabelFontStyle Sets whether a font should be styled with a normal or italic face from its family.
// .schema.traces.volume.attributes.hoverlabel.font.style
type VolumeHoverlabelFontStyle string

const (
	VolumeHoverlabelFontStyleNormal VolumeHoverlabelFontStyle = "normal"
	VolumeHoverlabelFontStyleItalic VolumeHoverlabelFontStyle = "italic"
)

// VolumeHoverlabelFontTextcase Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
// .schema.traces.volume.attributes.hoverlabel.font.textcase
type VolumeHoverlabelFontTextcase string

const (
	VolumeHoverlabelFontTextcaseNormal   VolumeHoverlabelFontTextcase = "normal"
	VolumeHoverlabelFontTextcaseWordCaps VolumeHoverlabelFontTextcase = "word caps"
	VolumeHoverlabelFontTextcaseUpper    VolumeHoverlabelFontTextcase = "upper"
	VolumeHoverlabelFontTextcaseLower    VolumeHoverlabelFontTextcase = "lower"
)

// VolumeHoverlabelFontVariant Sets the variant of the font.
// .schema.traces.volume.attributes.hoverlabel.font.variant
type VolumeHoverlabelFontVariant string

const (
	VolumeHoverlabelFontVariantNormal        VolumeHoverlabelFontVariant = "normal"
	VolumeHoverlabelFontVariantSmallCaps     VolumeHoverlabelFontVariant = "small-caps"
	VolumeHoverlabelFontVariantAllSmallCaps  VolumeHoverlabelFontVariant = "all-small-caps"
	VolumeHoverlabelFontVariantAllPetiteCaps VolumeHoverlabelFontVariant = "all-petite-caps"
	VolumeHoverlabelFontVariantPetiteCaps    VolumeHoverlabelFontVariant = "petite-caps"
	VolumeHoverlabelFontVariantUnicase       VolumeHoverlabelFontVariant = "unicase"
)

// VolumeLegendgrouptitleFontStyle Sets whether a font should be styled with a normal or italic face from its family.
// .schema.traces.volume.attributes.legendgrouptitle.font.style
type VolumeLegendgrouptitleFontStyle string

const (
	VolumeLegendgrouptitleFontStyleNormal VolumeLegendgrouptitleFontStyle = "normal"
	VolumeLegendgrouptitleFontStyleItalic VolumeLegendgrouptitleFontStyle = "italic"
)

// VolumeLegendgrouptitleFontTextcase Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
// .schema.traces.volume.attributes.legendgrouptitle.font.textcase
type VolumeLegendgrouptitleFontTextcase string

const (
	VolumeLegendgrouptitleFontTextcaseNormal   VolumeLegendgrouptitleFontTextcase = "normal"
	VolumeLegendgrouptitleFontTextcaseWordCaps VolumeLegendgrouptitleFontTextcase = "word caps"
	VolumeLegendgrouptitleFontTextcaseUpper    VolumeLegendgrouptitleFontTextcase = "upper"
	VolumeLegendgrouptitleFontTextcaseLower    VolumeLegendgrouptitleFontTextcase = "lower"
)

// VolumeLegendgrouptitleFontVariant Sets the variant of the font.
// .schema.traces.volume.attributes.legendgrouptitle.font.variant
type VolumeLegendgrouptitleFontVariant string

const (
	VolumeLegendgrouptitleFontVariantNormal        VolumeLegendgrouptitleFontVariant = "normal"
	VolumeLegendgrouptitleFontVariantSmallCaps     VolumeLegendgrouptitleFontVariant = "small-caps"
	VolumeLegendgrouptitleFontVariantAllSmallCaps  VolumeLegendgrouptitleFontVariant = "all-small-caps"
	VolumeLegendgrouptitleFontVariantAllPetiteCaps VolumeLegendgrouptitleFontVariant = "all-petite-caps"
	VolumeLegendgrouptitleFontVariantPetiteCaps    VolumeLegendgrouptitleFontVariant = "petite-caps"
	VolumeLegendgrouptitleFontVariantUnicase       VolumeLegendgrouptitleFontVariant = "unicase"
)
...
// VolumeColorbarTickfontLineposition Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
// .schema.traces.volume.attributes.colorbar.tickfont.lineposition
type VolumeColorbarTickfontLineposition string

const (
	// Flags
	VolumeColorbarTickfontLinepositionUnder   VolumeColorbarTickfontLineposition = "under"
	VolumeColorbarTickfontLinepositionOver    VolumeColorbarTickfontLineposition = "over"
	VolumeColorbarTickfontLinepositionThrough VolumeColorbarTickfontLineposition = "through"

	// Extra
	VolumeColorbarTickfontLinepositionNone VolumeColorbarTickfontLineposition = "none"
)

// VolumeColorbarTitleFontLineposition Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
// .schema.traces.volume.attributes.colorbar.title.font.lineposition
type VolumeColorbarTitleFontLineposition string

const (
	// Flags
	VolumeColorbarTitleFontLinepositionUnder   VolumeColorbarTitleFontLineposition = "under"
	VolumeColorbarTitleFontLinepositionOver    VolumeColorbarTitleFontLineposition = "over"
	VolumeColorbarTitleFontLinepositionThrough VolumeColorbarTitleFontLineposition = "through"

	// Extra
	VolumeColorbarTitleFontLinepositionNone VolumeColorbarTitleFontLineposition = "none"
)
...
// VolumeHoverlabelFontLineposition Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
// .schema.traces.volume.attributes.hoverlabel.font.lineposition
type VolumeHoverlabelFontLineposition string

const (
	// Flags
	VolumeHoverlabelFontLinepositionUnder   VolumeHoverlabelFontLineposition = "under"
	VolumeHoverlabelFontLinepositionOver    VolumeHoverlabelFontLineposition = "over"
	VolumeHoverlabelFontLinepositionThrough VolumeHoverlabelFontLineposition = "through"

	// Extra
	VolumeHoverlabelFontLinepositionNone VolumeHoverlabelFontLineposition = "none"
)

// VolumeLegendgrouptitleFontLineposition Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
// .schema.traces.volume.attributes.legendgrouptitle.font.lineposition
type VolumeLegendgrouptitleFontLineposition string

const (
	// Flags
	VolumeLegendgrouptitleFontLinepositionUnder   VolumeLegendgrouptitleFontLineposition = "under"
	VolumeLegendgrouptitleFontLinepositionOver    VolumeLegendgrouptitleFontLineposition = "over"
	VolumeLegendgrouptitleFontLinepositionThrough VolumeLegendgrouptitleFontLineposition = "through"

	// Extra
	VolumeLegendgrouptitleFontLinepositionNone VolumeLegendgrouptitleFontLineposition = "none"
)
