...
func (fig *Fig) Info() types.Version {
	return types.Version{
		...
		Tag: "v3.0.1",
		//
		URL: "https://raw.githubusercontent.com/plotly/plotly.js/v3.0.1/test/plot-schema.json",
		//
		Path: "schemas/v3.0.1/plot-schema.json",
		//
		Generated: "generated/v3.0.1",
		//
		Cdn: "https://cdn.plot.ly/plotly-3.0.1.min.js",
	}
}
