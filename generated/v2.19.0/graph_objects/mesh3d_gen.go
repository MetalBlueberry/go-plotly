...
type Mesh3d struct {
	...
	Facecolorsrc types.String `json:"facecolorsrc,omitempty"`
	...
	Intensitysrc types.String `json:"intensitysrc,omitempty"`

	// Isrc
	// arrayOK: false
	// type: string
	// Sets the source reference on Chart Studio Cloud for `i`.
	Isrc types.String `json:"isrc,omitempty"`
	...
	Jsrc types.String `json:"jsrc,omitempty"`
	...
	Ksrc types.String `json:"ksrc,omitempty"`
	...
	Vertexcolorsrc types.String `json:"vertexcolorsrc,omitempty"`
