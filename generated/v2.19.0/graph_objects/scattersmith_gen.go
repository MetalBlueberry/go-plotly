...
type Scattersmith struct {
	...
	Hoverinfo ScattersmithHoverinfo `json:"hoverinfo,omitempty"`
	...
	Textposition ScattersmithTextposition `json:"textposition,omitempty"`
...
type ScattersmithHoverlabel struct {
	...
	Align ScattersmithHoverlabelAlign `json:"align,omitempty"`
...
type ScattersmithMarkerGradient struct {
	...
	Type ScattersmithMarkerGradientType `json:"type,omitempty"`
...
type ScattersmithMarker struct {
	...
	Symbol ScattersmithMarkerSymbol `json:"symbol,omitempty"`
