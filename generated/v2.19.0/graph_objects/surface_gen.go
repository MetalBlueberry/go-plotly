...
func (trace *Surface) MarshalJSON() ([]byte, error) {
...
type Surface struct {
	...
	Hoverinfo arrayok.Type[*SurfaceHoverinfo] `json:"hoverinfo,omitempty"`
...
type SurfaceHoverlabel struct {
	...
	Align arrayok.Type[*SurfaceHoverlabelAlign] `json:"align,omitempty"`
