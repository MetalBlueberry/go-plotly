...
func (trace *Funnel) MarshalJSON() ([]byte, error) {
...
type Funnel struct {
	...
	Hoverinfo arrayok.Type[*FunnelHoverinfo] `json:"hoverinfo,omitempty"`
	...
	Textposition arrayok.Type[*FunnelTextposition] `json:"textposition,omitempty"`
