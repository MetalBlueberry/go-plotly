...
type Pointcloud struct {
	...
	// .schema.traces.pointcloud.attributes.legend
...
type PointcloudHoverlabelFont struct {
	...
	// .schema.traces.pointcloud.attributes.hoverlabel.font.lineposition
	Lineposition *types.ArrayOK[*PointcloudHoverlabelFontLineposition] `json:"lineposition,omitempty"`

	// Linepositionsrc
	// arrayOK: false
	// type: string
	// Sets the source reference on Chart Studio Cloud for `lineposition`.
	// .schema.traces.pointcloud.attributes.hoverlabel.font.linepositionsrc
	...
	// .schema.traces.pointcloud.attributes.hoverlabel.font.shadow
	...
	// .schema.traces.pointcloud.attributes.hoverlabel.font.shadowsrc
	...
	// .schema.traces.pointcloud.attributes.hoverlabel.font.style
	Style *types.ArrayOK[*PointcloudHoverlabelFontStyle] `json:"style,omitempty"`

	// Stylesrc
	// arrayOK: false
	// type: string
	// Sets the source reference on Chart Studio Cloud for `style`.
	// .schema.traces.pointcloud.attributes.hoverlabel.font.stylesrc
	...
	// .schema.traces.pointcloud.attributes.hoverlabel.font.textcase
	Textcase *types.ArrayOK[*PointcloudHoverlabelFontTextcase] `json:"textcase,omitempty"`

	// Textcasesrc
	// arrayOK: false
	// type: string
	// Sets the source reference on Chart Studio Cloud for `textcase`.
	// .schema.traces.pointcloud.attributes.hoverlabel.font.textcasesrc
	...
	// .schema.traces.pointcloud.attributes.hoverlabel.font.variant
	Variant *types.ArrayOK[*PointcloudHoverlabelFontVariant] `json:"variant,omitempty"`

	// Variantsrc
	// arrayOK: false
	// type: string
	// Sets the source reference on Chart Studio Cloud for `variant`.
	// .schema.traces.pointcloud.attributes.hoverlabel.font.variantsrc
	...
	// .schema.traces.pointcloud.attributes.hoverlabel.font.weight
	...
	// .schema.traces.pointcloud.attributes.hoverlabel.font.weightsrc
...
type PointcloudLegendgrouptitleFont struct {
	...
	// type: flaglist
	// Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
	// .schema.traces.pointcloud.attributes.legendgrouptitle.font.lineposition
	Lineposition PointcloudLegendgrouptitleFontLineposition `json:"lineposition,omitempty"`

	// Shadow
	// arrayOK: false
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.pointcloud.attributes.legendgrouptitle.font.shadow
	...
	// type: enumerated
	// Sets whether a font should be styled with a normal or italic face from its family.
	// .schema.traces.pointcloud.attributes.legendgrouptitle.font.style
	Style PointcloudLegendgrouptitleFontStyle `json:"style,omitempty"`
	...
	// type: enumerated
	// Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
	// .schema.traces.pointcloud.attributes.legendgrouptitle.font.textcase
	Textcase PointcloudLegendgrouptitleFontTextcase `json:"textcase,omitempty"`
	...
	// type: enumerated
	// Sets the variant of the font.
	// .schema.traces.pointcloud.attributes.legendgrouptitle.font.variant
	Variant PointcloudLegendgrouptitleFontVariant `json:"variant,omitempty"`

	// Weight
	// arrayOK: false
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.pointcloud.attributes.legendgrouptitle.font.weight
...
// PointcloudHoverlabelFontStyle Sets whether a font should be styled with a normal or italic face from its family.
// .schema.traces.pointcloud.attributes.hoverlabel.font.style
type PointcloudHoverlabelFontStyle string

const (
	PointcloudHoverlabelFontStyleNormal PointcloudHoverlabelFontStyle = "normal"
	PointcloudHoverlabelFontStyleItalic PointcloudHoverlabelFontStyle = "italic"
)

// PointcloudHoverlabelFontTextcase Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
// .schema.traces.pointcloud.attributes.hoverlabel.font.textcase
type PointcloudHoverlabelFontTextcase string

const (
	PointcloudHoverlabelFontTextcaseNormal   PointcloudHoverlabelFontTextcase = "normal"
	PointcloudHoverlabelFontTextcaseWordCaps PointcloudHoverlabelFontTextcase = "word caps"
	PointcloudHoverlabelFontTextcaseUpper    PointcloudHoverlabelFontTextcase = "upper"
	PointcloudHoverlabelFontTextcaseLower    PointcloudHoverlabelFontTextcase = "lower"
)

// PointcloudHoverlabelFontVariant Sets the variant of the font.
// .schema.traces.pointcloud.attributes.hoverlabel.font.variant
type PointcloudHoverlabelFontVariant string

const (
	PointcloudHoverlabelFontVariantNormal        PointcloudHoverlabelFontVariant = "normal"
	PointcloudHoverlabelFontVariantSmallCaps     PointcloudHoverlabelFontVariant = "small-caps"
	PointcloudHoverlabelFontVariantAllSmallCaps  PointcloudHoverlabelFontVariant = "all-small-caps"
	PointcloudHoverlabelFontVariantAllPetiteCaps PointcloudHoverlabelFontVariant = "all-petite-caps"
	PointcloudHoverlabelFontVariantPetiteCaps    PointcloudHoverlabelFontVariant = "petite-caps"
	PointcloudHoverlabelFontVariantUnicase       PointcloudHoverlabelFontVariant = "unicase"
)

// PointcloudLegendgrouptitleFontStyle Sets whether a font should be styled with a normal or italic face from its family.
// .schema.traces.pointcloud.attributes.legendgrouptitle.font.style
type PointcloudLegendgrouptitleFontStyle string

const (
	PointcloudLegendgrouptitleFontStyleNormal PointcloudLegendgrouptitleFontStyle = "normal"
	PointcloudLegendgrouptitleFontStyleItalic PointcloudLegendgrouptitleFontStyle = "italic"
)

// PointcloudLegendgrouptitleFontTextcase Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
// .schema.traces.pointcloud.attributes.legendgrouptitle.font.textcase
type PointcloudLegendgrouptitleFontTextcase string

const (
	PointcloudLegendgrouptitleFontTextcaseNormal   PointcloudLegendgrouptitleFontTextcase = "normal"
	PointcloudLegendgrouptitleFontTextcaseWordCaps PointcloudLegendgrouptitleFontTextcase = "word caps"
	PointcloudLegendgrouptitleFontTextcaseUpper    PointcloudLegendgrouptitleFontTextcase = "upper"
	PointcloudLegendgrouptitleFontTextcaseLower    PointcloudLegendgrouptitleFontTextcase = "lower"
)

// PointcloudLegendgrouptitleFontVariant Sets the variant of the font.
// .schema.traces.pointcloud.attributes.legendgrouptitle.font.variant
type PointcloudLegendgrouptitleFontVariant string

const (
	PointcloudLegendgrouptitleFontVariantNormal        PointcloudLegendgrouptitleFontVariant = "normal"
	PointcloudLegendgrouptitleFontVariantSmallCaps     PointcloudLegendgrouptitleFontVariant = "small-caps"
	PointcloudLegendgrouptitleFontVariantAllSmallCaps  PointcloudLegendgrouptitleFontVariant = "all-small-caps"
	PointcloudLegendgrouptitleFontVariantAllPetiteCaps PointcloudLegendgrouptitleFontVariant = "all-petite-caps"
	PointcloudLegendgrouptitleFontVariantPetiteCaps    PointcloudLegendgrouptitleFontVariant = "petite-caps"
	PointcloudLegendgrouptitleFontVariantUnicase       PointcloudLegendgrouptitleFontVariant = "unicase"
)
...
// PointcloudHoverlabelFontLineposition Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
// .schema.traces.pointcloud.attributes.hoverlabel.font.lineposition
type PointcloudHoverlabelFontLineposition string

const (
	// Flags
	PointcloudHoverlabelFontLinepositionUnder   PointcloudHoverlabelFontLineposition = "under"
	PointcloudHoverlabelFontLinepositionOver    PointcloudHoverlabelFontLineposition = "over"
	PointcloudHoverlabelFontLinepositionThrough PointcloudHoverlabelFontLineposition = "through"

	// Extra
	PointcloudHoverlabelFontLinepositionNone PointcloudHoverlabelFontLineposition = "none"
)

// PointcloudLegendgrouptitleFontLineposition Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
// .schema.traces.pointcloud.attributes.legendgrouptitle.font.lineposition
type PointcloudLegendgrouptitleFontLineposition string

const (
	// Flags
	PointcloudLegendgrouptitleFontLinepositionUnder   PointcloudLegendgrouptitleFontLineposition = "under"
	PointcloudLegendgrouptitleFontLinepositionOver    PointcloudLegendgrouptitleFontLineposition = "over"
	PointcloudLegendgrouptitleFontLinepositionThrough PointcloudLegendgrouptitleFontLineposition = "through"

	// Extra
	PointcloudLegendgrouptitleFontLinepositionNone PointcloudLegendgrouptitleFontLineposition = "none"
)
