...
type OhlcHoverlabelFont struct {
	...
	// .schema.traces.ohlc.attributes.hoverlabel.font.lineposition
	...
	// .schema.traces.ohlc.attributes.hoverlabel.font.linepositionsrc
	...
	// .schema.traces.ohlc.attributes.hoverlabel.font.shadow
	...
	// .schema.traces.ohlc.attributes.hoverlabel.font.shadowsrc
	...
	// .schema.traces.ohlc.attributes.hoverlabel.font.style
	...
	// .schema.traces.ohlc.attributes.hoverlabel.font.stylesrc
	...
	// .schema.traces.ohlc.attributes.hoverlabel.font.textcase
	...
	// .schema.traces.ohlc.attributes.hoverlabel.font.textcasesrc
	...
	// .schema.traces.ohlc.attributes.hoverlabel.font.variant
	...
	// .schema.traces.ohlc.attributes.hoverlabel.font.variantsrc
	...
	// .schema.traces.ohlc.attributes.hoverlabel.font.weight
	...
	// .schema.traces.ohlc.attributes.hoverlabel.font.weightsrc
...
type OhlcLegendgrouptitleFont struct {
	...
	// type: flaglist
	// Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
	// .schema.traces.ohlc.attributes.legendgrouptitle.font.lineposition
	...
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.ohlc.attributes.legendgrouptitle.font.shadow
	...
	// type: enumerated
	// Sets whether a font should be styled with a normal or italic face from its family.
	// .schema.traces.ohlc.attributes.legendgrouptitle.font.style
	...
	// type: enumerated
	// Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
	// .schema.traces.ohlc.attributes.legendgrouptitle.font.textcase
	...
	// type: enumerated
	// Sets the variant of the font.
	// .schema.traces.ohlc.attributes.legendgrouptitle.font.variant
	...
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.ohlc.attributes.legendgrouptitle.font.weight
