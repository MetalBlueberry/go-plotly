...
type Box struct {
	...
	// .schema.traces.box.attributes.zorder
...
type BoxHoverlabelFont struct {
	...
	// .schema.traces.box.attributes.hoverlabel.font.lineposition
	Lineposition *types.ArrayOK[*BoxHoverlabelFontLineposition] `json:"lineposition,omitempty"`

	// Linepositionsrc
	// arrayOK: false
	// type: string
	// Sets the source reference on Chart Studio Cloud for `lineposition`.
	// .schema.traces.box.attributes.hoverlabel.font.linepositionsrc
	...
	// .schema.traces.box.attributes.hoverlabel.font.shadow
	...
	// .schema.traces.box.attributes.hoverlabel.font.shadowsrc
	...
	// .schema.traces.box.attributes.hoverlabel.font.style
	Style *types.ArrayOK[*BoxHoverlabelFontStyle] `json:"style,omitempty"`

	// Stylesrc
	// arrayOK: false
	// type: string
	// Sets the source reference on Chart Studio Cloud for `style`.
	// .schema.traces.box.attributes.hoverlabel.font.stylesrc
	...
	// .schema.traces.box.attributes.hoverlabel.font.textcase
	Textcase *types.ArrayOK[*BoxHoverlabelFontTextcase] `json:"textcase,omitempty"`

	// Textcasesrc
	// arrayOK: false
	// type: string
	// Sets the source reference on Chart Studio Cloud for `textcase`.
	// .schema.traces.box.attributes.hoverlabel.font.textcasesrc
	...
	// .schema.traces.box.attributes.hoverlabel.font.variant
	Variant *types.ArrayOK[*BoxHoverlabelFontVariant] `json:"variant,omitempty"`

	// Variantsrc
	// arrayOK: false
	// type: string
	// Sets the source reference on Chart Studio Cloud for `variant`.
	// .schema.traces.box.attributes.hoverlabel.font.variantsrc
	...
	// .schema.traces.box.attributes.hoverlabel.font.weight
	...
	// .schema.traces.box.attributes.hoverlabel.font.weightsrc
...
type BoxLegendgrouptitleFont struct {
	...
	// type: flaglist
	// Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
	// .schema.traces.box.attributes.legendgrouptitle.font.lineposition
	Lineposition BoxLegendgrouptitleFontLineposition `json:"lineposition,omitempty"`

	// Shadow
	// arrayOK: false
	// type: string
	// Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
	// .schema.traces.box.attributes.legendgrouptitle.font.shadow
	...
	// type: enumerated
	// Sets whether a font should be styled with a normal or italic face from its family.
	// .schema.traces.box.attributes.legendgrouptitle.font.style
	Style BoxLegendgrouptitleFontStyle `json:"style,omitempty"`
	...
	// type: enumerated
	// Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
	// .schema.traces.box.attributes.legendgrouptitle.font.textcase
	Textcase BoxLegendgrouptitleFontTextcase `json:"textcase,omitempty"`
	...
	// type: enumerated
	// Sets the variant of the font.
	// .schema.traces.box.attributes.legendgrouptitle.font.variant
	Variant BoxLegendgrouptitleFontVariant `json:"variant,omitempty"`

	// Weight
	// arrayOK: false
	// type: integer
	// Sets the weight (or boldness) of the font.
	// .schema.traces.box.attributes.legendgrouptitle.font.weight
...
// BoxHoverlabelFontStyle Sets whether a font should be styled with a normal or italic face from its family.
// .schema.traces.box.attributes.hoverlabel.font.style
type BoxHoverlabelFontStyle string

const (
	BoxHoverlabelFontStyleNormal BoxHoverlabelFontStyle = "normal"
	BoxHoverlabelFontStyleItalic BoxHoverlabelFontStyle = "italic"
)

// BoxHoverlabelFontTextcase Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
// .schema.traces.box.attributes.hoverlabel.font.textcase
type BoxHoverlabelFontTextcase string

const (
	BoxHoverlabelFontTextcaseNormal   BoxHoverlabelFontTextcase = "normal"
	BoxHoverlabelFontTextcaseWordCaps BoxHoverlabelFontTextcase = "word caps"
	BoxHoverlabelFontTextcaseUpper    BoxHoverlabelFontTextcase = "upper"
	BoxHoverlabelFontTextcaseLower    BoxHoverlabelFontTextcase = "lower"
)

// BoxHoverlabelFontVariant Sets the variant of the font.
// .schema.traces.box.attributes.hoverlabel.font.variant
type BoxHoverlabelFontVariant string

const (
	BoxHoverlabelFontVariantNormal        BoxHoverlabelFontVariant = "normal"
	BoxHoverlabelFontVariantSmallCaps     BoxHoverlabelFontVariant = "small-caps"
	BoxHoverlabelFontVariantAllSmallCaps  BoxHoverlabelFontVariant = "all-small-caps"
	BoxHoverlabelFontVariantAllPetiteCaps BoxHoverlabelFontVariant = "all-petite-caps"
	BoxHoverlabelFontVariantPetiteCaps    BoxHoverlabelFontVariant = "petite-caps"
	BoxHoverlabelFontVariantUnicase       BoxHoverlabelFontVariant = "unicase"
)

// BoxLegendgrouptitleFontStyle Sets whether a font should be styled with a normal or italic face from its family.
// .schema.traces.box.attributes.legendgrouptitle.font.style
type BoxLegendgrouptitleFontStyle string

const (
	BoxLegendgrouptitleFontStyleNormal BoxLegendgrouptitleFontStyle = "normal"
	BoxLegendgrouptitleFontStyleItalic BoxLegendgrouptitleFontStyle = "italic"
)

// BoxLegendgrouptitleFontTextcase Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized.
// .schema.traces.box.attributes.legendgrouptitle.font.textcase
type BoxLegendgrouptitleFontTextcase string

const (
	BoxLegendgrouptitleFontTextcaseNormal   BoxLegendgrouptitleFontTextcase = "normal"
	BoxLegendgrouptitleFontTextcaseWordCaps BoxLegendgrouptitleFontTextcase = "word caps"
	BoxLegendgrouptitleFontTextcaseUpper    BoxLegendgrouptitleFontTextcase = "upper"
	BoxLegendgrouptitleFontTextcaseLower    BoxLegendgrouptitleFontTextcase = "lower"
)

// BoxLegendgrouptitleFontVariant Sets the variant of the font.
// .schema.traces.box.attributes.legendgrouptitle.font.variant
type BoxLegendgrouptitleFontVariant string

const (
	BoxLegendgrouptitleFontVariantNormal        BoxLegendgrouptitleFontVariant = "normal"
	BoxLegendgrouptitleFontVariantSmallCaps     BoxLegendgrouptitleFontVariant = "small-caps"
	BoxLegendgrouptitleFontVariantAllSmallCaps  BoxLegendgrouptitleFontVariant = "all-small-caps"
	BoxLegendgrouptitleFontVariantAllPetiteCaps BoxLegendgrouptitleFontVariant = "all-petite-caps"
	BoxLegendgrouptitleFontVariantPetiteCaps    BoxLegendgrouptitleFontVariant = "petite-caps"
	BoxLegendgrouptitleFontVariantUnicase       BoxLegendgrouptitleFontVariant = "unicase"
)
...
// BoxHoverlabelFontLineposition Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
// .schema.traces.box.attributes.hoverlabel.font.lineposition
type BoxHoverlabelFontLineposition string

const (
	// Flags
	BoxHoverlabelFontLinepositionUnder   BoxHoverlabelFontLineposition = "under"
	BoxHoverlabelFontLinepositionOver    BoxHoverlabelFontLineposition = "over"
	BoxHoverlabelFontLinepositionThrough BoxHoverlabelFontLineposition = "through"

	// Extra
	BoxHoverlabelFontLinepositionNone BoxHoverlabelFontLineposition = "none"
)
...
// BoxLegendgrouptitleFontLineposition Sets the kind of decoration line(s) with text, such as an *under*, *over* or *through* as well as combinations e.g. *under+over*, etc.
// .schema.traces.box.attributes.legendgrouptitle.font.lineposition
type BoxLegendgrouptitleFontLineposition string

const (
	// Flags
	BoxLegendgrouptitleFontLinepositionUnder   BoxLegendgrouptitleFontLineposition = "under"
	BoxLegendgrouptitleFontLinepositionOver    BoxLegendgrouptitleFontLineposition = "over"
	BoxLegendgrouptitleFontLinepositionThrough BoxLegendgrouptitleFontLineposition = "through"

	// Extra
	BoxLegendgrouptitleFontLinepositionNone BoxLegendgrouptitleFontLineposition = "none"
)
