...
type Histogram2dcontour struct {
	...
	Autobinx types.Bool `json:"autobinx,omitempty"`
	...
	Autobiny types.Bool `json:"autobiny,omitempty"`
	...
	Autocontour types.Bool `json:"autocontour,omitempty"`
	...
	Bingroup types.String `json:"bingroup,omitempty"`
	...
	Xbingroup types.String `json:"xbingroup,omitempty"`
	...
	Ybingroup types.String `json:"ybingroup,omitempty"`
...
type Histogram2dcontourContours struct {
	...
	Labelformat types.String `json:"labelformat,omitempty"`
