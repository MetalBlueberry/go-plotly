...
func (trace *Box) MarshalJSON() ([]byte, error) {
...
type Box struct {
	...
	Hoverinfo arrayok.Type[*BoxHoverinfo] `json:"hoverinfo,omitempty"`
...
type BoxHoverlabel struct {
	...
	Align arrayok.Type[*BoxHoverlabelAlign] `json:"align,omitempty"`
