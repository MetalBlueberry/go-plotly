...
func (trace *Scatterpolar) MarshalJSON() ([]byte, error) {
...
type Scatterpolar struct {
	...
	Hoverinfo arrayok.Type[*ScatterpolarHoverinfo] `json:"hoverinfo,omitempty"`
	...
	Textposition arrayok.Type[*ScatterpolarTextposition] `json:"textposition,omitempty"`
...
type ScatterpolarMarkerGradient struct {
	...
	Type arrayok.Type[*ScatterpolarMarkerGradientType] `json:"type,omitempty"`
