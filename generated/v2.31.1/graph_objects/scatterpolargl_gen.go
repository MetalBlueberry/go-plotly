...
func (trace *Scatterpolargl) MarshalJSON() ([]byte, error) {
...
type Scatterpolargl struct {
	...
	Hoverinfo arrayok.Type[*ScatterpolarglHoverinfo] `json:"hoverinfo,omitempty"`
	...
	Textposition arrayok.Type[*ScatterpolarglTextposition] `json:"textposition,omitempty"`
