...
func (trace *Densitymapbox) MarshalJSON() ([]byte, error) {
...
type Densitymapbox struct {
	...
	Hoverinfo arrayok.Type[*DensitymapboxHoverinfo] `json:"hoverinfo,omitempty"`
	...
	Radius arrayok.Type[*float64] `json:"radius,omitempty"`
