...
func (trace *Bar) MarshalJSON() ([]byte, error) {
...
type Bar struct {
	...
	Hoverinfo arrayok.Type[*BarHoverinfo] `json:"hoverinfo,omitempty"`
	...
	Textposition arrayok.Type[*BarTextposition] `json:"textposition,omitempty"`
...
type BarMarkerPattern struct {
	...
	Shape arrayok.Type[*BarMarkerPatternShape] `json:"shape,omitempty"`
