...
type Scattersmith struct {
	...
	Hoverinfo ArrayOK[*ScattersmithHoverinfo] `json:"hoverinfo,omitempty"`
	...
	Textposition ArrayOK[*ScattersmithTextposition] `json:"textposition,omitempty"`
...
type ScattersmithMarkerGradient struct {
	...
	Type ArrayOK[*ScattersmithMarkerGradientType] `json:"type,omitempty"`
...
type ScattersmithMarker struct {
	...
	Symbol ArrayOK[*ScattersmithMarkerSymbol] `json:"symbol,omitempty"`
