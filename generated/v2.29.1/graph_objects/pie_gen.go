...
func (trace *Pie) MarshalJSON() ([]byte, error) {
...
type Pie struct {
	...
	Hoverinfo arrayok.Type[*PieHoverinfo] `json:"hoverinfo,omitempty"`
	...
	Pull arrayok.Type[*float64] `json:"pull,omitempty"`
	...
	Textposition arrayok.Type[*PieTextposition] `json:"textposition,omitempty"`
...
type PieMarkerPattern struct {
	...
	Shape arrayok.Type[*PieMarkerPatternShape] `json:"shape,omitempty"`
