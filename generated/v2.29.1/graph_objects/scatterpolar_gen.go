...
type Scatterpolar struct {
	...
	Hoverinfo ArrayOK[*ScatterpolarHoverinfo] `json:"hoverinfo,omitempty"`
	...
	Textposition ArrayOK[*ScatterpolarTextposition] `json:"textposition,omitempty"`
...
type ScatterpolarLine struct {
	...
	Backoff ArrayOK[*float64] `json:"backoff,omitempty"`
...
type ScatterpolarMarkerGradient struct {
	...
	Type ArrayOK[*ScatterpolarMarkerGradientType] `json:"type,omitempty"`
...
type ScatterpolarMarker struct {
	...
	Standoff ArrayOK[*float64] `json:"standoff,omitempty"`
	...
	Symbol ArrayOK[*ScatterpolarMarkerSymbol] `json:"symbol,omitempty"`
