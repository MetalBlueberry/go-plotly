...
func (trace *Icicle) MarshalJSON() ([]byte, error) {
...
type Icicle struct {
	...
	Hoverinfo arrayok.Type[*IcicleHoverinfo] `json:"hoverinfo,omitempty"`
...
type IcicleMarkerPattern struct {
	...
	Shape arrayok.Type[*IcicleMarkerPatternShape] `json:"shape,omitempty"`
