...
func (trace *Scatter3d) MarshalJSON() ([]byte, error) {
...
type Scatter3d struct {
	...
	Hoverinfo arrayok.Type[*Scatter3dHoverinfo] `json:"hoverinfo,omitempty"`
	...
	Surfacecolor color.String `json:"surfacecolor,omitempty"`
	...
	Textposition arrayok.Type[*Scatter3dTextposition] `json:"textposition,omitempty"`
...
type Scatter3dHoverlabel struct {
	...
	Align arrayok.Type[*Scatter3dHoverlabelAlign] `json:"align,omitempty"`
