...
type Sunburst struct {
	...
	Hoverinfo ArrayOK[*SunburstHoverinfo] `json:"hoverinfo,omitempty"`
...
type SunburstHoverlabel struct {
	...
	Align ArrayOK[*SunburstHoverlabelAlign] `json:"align,omitempty"`
...
type SunburstMarkerPattern struct {
	...
	Shape ArrayOK[*SunburstMarkerPatternShape] `json:"shape,omitempty"`
