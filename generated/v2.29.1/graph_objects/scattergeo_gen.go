...
func (trace *Scattergeo) MarshalJSON() ([]byte, error) {
...
type Scattergeo struct {
	...
	Hoverinfo arrayok.Type[*ScattergeoHoverinfo] `json:"hoverinfo,omitempty"`
	...
	Textposition arrayok.Type[*ScattergeoTextposition] `json:"textposition,omitempty"`
...
type ScattergeoMarkerGradient struct {
	...
	Type arrayok.Type[*ScattergeoMarkerGradientType] `json:"type,omitempty"`
