...
func (trace *Scatter) MarshalJSON() ([]byte, error) {
...
type Scatter struct {
	...
	Hoverinfo arrayok.Type[*ScatterHoverinfo] `json:"hoverinfo,omitempty"`
	...
	Textposition arrayok.Type[*ScatterTextposition] `json:"textposition,omitempty"`
...
type ScatterFillpattern struct {
	...
	Shape arrayok.Type[*ScatterFillpatternShape] `json:"shape,omitempty"`
...
type ScatterMarkerGradient struct {
	...
	Type arrayok.Type[*ScatterMarkerGradientType] `json:"type,omitempty"`
