...
func (trace *Treemap) MarshalJSON() ([]byte, error) {
...
type Treemap struct {
	...
	Hoverinfo arrayok.Type[*TreemapHoverinfo] `json:"hoverinfo,omitempty"`
...
type TreemapMarkerPattern struct {
	...
	Shape arrayok.Type[*TreemapMarkerPatternShape] `json:"shape,omitempty"`
