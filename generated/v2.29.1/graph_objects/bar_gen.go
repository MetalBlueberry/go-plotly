...
type Bar struct {
	...
	Base ArrayOK[*interface{}] `json:"base,omitempty"`
	...
	Hoverinfo ArrayOK[*BarHoverinfo] `json:"hoverinfo,omitempty"`
	...
	Textposition ArrayOK[*BarTextposition] `json:"textposition,omitempty"`
...
type BarMarkerPattern struct {
	...
	Shape ArrayOK[*BarMarkerPatternShape] `json:"shape,omitempty"`
