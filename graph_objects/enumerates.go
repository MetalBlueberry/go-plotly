...
const (
    LayoutBarmode_stack LayoutBarmode = "stack" // stack
    LayoutBarmode_group LayoutBarmode = "group" // group
    LayoutBarmode_overlay LayoutBarmode = "overlay" // overlay
    LayoutBarmode_relative LayoutBarmode = "relative" // relative
)
...
const (
    LayoutBarnorm_fraction LayoutBarnorm = "fraction" // fraction
    LayoutBarnorm_percent LayoutBarnorm = "percent" // percent
)
...
const (
    LayoutBoxmode_group LayoutBoxmode = "group" // group
    LayoutBoxmode_overlay LayoutBoxmode = "overlay" // overlay
)
...
const (
    LayoutFunnelmode_stack LayoutFunnelmode = "stack" // stack
    LayoutFunnelmode_group LayoutFunnelmode = "group" // group
    LayoutFunnelmode_overlay LayoutFunnelmode = "overlay" // overlay
)
...
const (
    LayoutViolinmode_group LayoutViolinmode = "group" // group
    LayoutViolinmode_overlay LayoutViolinmode = "overlay" // overlay
)
...
const (
    LayoutWaterfallmode_group LayoutWaterfallmode = "group" // group
    LayoutWaterfallmode_overlay LayoutWaterfallmode = "overlay" // overlay
)
