...
type Scatter3d struct {
    ...
    // Surfaceaxis 
    // enumerated If *-1*, the scatter points are not fill with a surface If *0*, *1*, *2*, the scatter points are filled with a Delaunay surface about the x, y, z respectively. 
...
type Scatter3dLine struct {
    ...
    // Dash 
    // enumerated Sets the dash style of the lines. 
...
type Scatter3dMarker struct {
    ...
    // Symbol 
    // enumerated Sets the marker symbol type. 
